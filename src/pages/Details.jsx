...
//           factoryInfo: data.factoryname, // Should match server response
//           custStyle: data.custStyle, // Should match server response
//           country: data.country, // Should match server response
//         }));
...
//                       ...prev,
//                       selectedMono: mono,
//                       // Clear dependent fields when MONo changes
//                       color: "",
//                       size: "",
//                       buyer: "",
//                       orderQty: "",
...
//           <button
//             type="submit"
//             className="w-full bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mt-6"
//           >
