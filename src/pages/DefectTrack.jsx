                ...
                <div className="p-6 lg:p-8">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                      Scan a defect card QR code to start repair tracking
                      process
                    </p>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 lg:p-12 border dark:border-gray-700 transition-colors duration-300">
              <div className="text-center max-w-md mx-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                  Data view functionality is coming soon. This will display
                  comprehensive repair tracking records, analytics, and
                  reporting features.
                </p>
