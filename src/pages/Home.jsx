...
const TabletGridItem = ({ item, onClick, fincheckActionCount }) => {
  return (
    <div
      onClick={onClick}
     className={`relative flex flex-col items-center justify-center p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm cursor-pointer hover:shadow-md active:scale-[0.98] transition-all border-2 ${
        item.version === '0' 
          ? 'border-red-400 dark:border-red-500' 
          : item.version === '0.1' 
          ? 'border-green-400 dark:border-green-500' 
