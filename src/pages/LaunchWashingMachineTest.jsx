...
const LaundryWashingMachineTest = () => {
  ...
  if (!useFormStore.getState().formData.reportType) {
    useFormStore
      .getState()
      .resetForm(getInitialFormData(REPORT_TYPES.GARMENT_WASH));
  }
  ...
  const { causeAssignHistory, fetchAssignControl, fetchUsers } =
    useAssignControlStore();
  ...
  useEffect(() => {
    if (isWarehouseUser && activeTab === "reports")
      ...
      !isAdminUser &&
      !isWarehouseUser &&
      (activeTab === "warehouse_reports" || activeTab === "easy_scan")
    )
  ...
  useEffect(() => {
    const onMouseDown = (e) => {
      if (showColorDropdown && !e.target.closest(".color-dropdown-container"))
        setShowColorDropdown(false);
      if (showPODropdown && !e.target.closest(".po-dropdown-container"))
        setShowPODropdown(false);
      if (showETDDropdown && !e.target.closest(".etd-dropdown-container"))
        setShowETDDropdown(false);
      if (
        showEditColorDropdown &&
        !e.target.closest(".color-dropdown-container")
      )
        setShowEditColorDropdown(false);
      if (showEditPODropdown && !e.target.closest(".po-dropdown-container"))
        setShowEditPODropdown(false);
      if (showEditETDDropdown && !e.target.closest(".etd-dropdown-container"))
          ...
          <div className="mb-6 border-b border-gray-200 dark:border-gray-700">
            ...
            >
              ...
              {(isAdminUser ||
                !isWarehouseUser ||
                (isWarehouseUser &&
                  (activeTab === "form" || completingReport))) && (
                <button
                  onClick={() => setActiveTab("form")}
                  className={`flex-shrink-0 py-3 px-3 sm:px-4 border-b-2 font-medium text-xs sm:text-sm transition-colors whitespace-nowrap ${activeTab === "form" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"}`}
                >
              ...
              {(isAdminUser || !isWarehouseUser) && (
                <button
                  ...
                  className={`flex-shrink-0 py-3 px-3 sm:px-4 border-b-2 font-medium text-xs sm:text-sm transition-colors whitespace-nowrap ${activeTab === "reports" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"}`}
                >
                  <span className="flex items-center gap-1.5 sm:gap-2">
                    <HiClipboardList
                    ...
                    <span className="sm:hidden">
                      Reports{" "}
                      <span className="text-[10px] bg-blue-100 px-1.5 py-0.5 rounded-full">
              ...
              {(isAdminUser || isWarehouseUser) && (
                <button
                  ...
                  className={`flex-shrink-0 py-3 px-3 sm:px-4 border-b-2 font-medium text-xs sm:text-sm transition-colors whitespace-nowrap ${activeTab === "warehouse_reports" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"}`}
                >
                  <span className="flex items-center gap-1.5 sm:gap-2">
                    <MdWarehouse
              ...
              {(isAdminUser || isWarehouseUser) && (
                <button
                  onClick={() => setActiveTab("easy_scan")}
                  className={`flex-shrink-0 py-3 px-3 sm:px-4 border-b-2 font-medium text-xs sm:text-sm transition-colors whitespace-nowrap ${activeTab === "easy_scan" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"}`}
                >
                  <span className="flex items-center gap-1.5 sm:gap-2">
                    <ScanSearch
                      className={`w-4 h-4 sm:w-5 sm:h-5 ${activeTab === "easy_scan" ? "text-teal-600" : "text-teal-500/70"}`}
                    />
              ...
              {isAdminUser && (
                <button
                  ...
                  className={`flex-shrink-0 py-3 px-3 sm:px-4 border-b-2 font-medium text-xs sm:text-sm transition-colors whitespace-nowrap ${activeTab === "assign_control" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"}`}
                >
                  <span className="flex items-center gap-1.5 sm:gap-2">
                    <MdAssignmentInd
          ...
          {[
            {
              type: "initial",
              isOpen:
                editImagesModal.isOpen && editImagesModal.type === "initial",
              color: "blue",
              uploadType: "initial",
            },
            {
              type: "received",
              isOpen:
                editImagesModal.isOpen && editImagesModal.type === "received",
              color: "yellow",
              uploadType: "received",
            },
            {
              type: "completion",
              isOpen:
                editImagesModal.isOpen && editImagesModal.type === "completion",
              color: "green",
            ...
            <EditImagesModal
              ...
              onUploadImage={(files) =>
                handleEditImageUpload(files, uploadType)
              }
