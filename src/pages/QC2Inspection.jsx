    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800 text-gray-800 dark:text-gray-200">
      ...
      <div className="flex h-screen bg-transparent">
            ...
            {activeTab === "first" &&
              (!inDefectWindow ? (
                ...
                <QC2InspectionWindow
                  ...
                  isBluetoothConnected={isBluetoothConnected}
                  printing={printing}
                  handleRejectGarment={() => {}} // Add your implementation
                  handlePassBundle={handlePassBundle}
                  handleGenerateQRCodes={() => {}} // Add your implementation
                  handlePrintQRCode={() => {}} // Add your implementation
        ...
        <QRCodePreview
          ...
          onPrint={() => {}} // Add your implementation
          mode="bundle"
        />
      </div>
