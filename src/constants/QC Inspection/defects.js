...
export const allDefects = [
  ...
  },
  {
    ...
    khmer: "ការភ្ជាប់ស្លាក Jocker/Match Book មិនត្រឹមត្រូវ",
    chinese: "错误贴附 Jocker 标签/匹配簿",
    image: "assets/Img/p.jpg",
    repair: "OPA",
  },
  {
    english: "Incorrect attach Jocker tag/Match Book placement",
    khmer: "ការដាក់ស្លាក Jocker/Match Book នៅទីតាំងមិនត្រឹមត្រូវ",
    chinese: "Jocker 标签/匹配簿放置错误",
    image: "assets/Img/p.jpg",
    repair: "OPA",
  },
  {
    english: "Creases/Wrinkles/Water mark",
    khmer: "របួស/រោម/ស្លាកទឹក",
    chinese: "折痕/皱纹/水印",
    image: "assets/Img/p.jpg",
    repair: "Laundry",
  },
