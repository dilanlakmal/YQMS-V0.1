    ...
    <div className="w-full max-w-md mx-auto">
      ...
      >
        ...
        {processing ? (
          ...
          <div className="flex flex-col items-center">
            <div
              className={`p-3 rounded-full mb-4 transition-colors duration-300 ${
                disabled
      ...
      {!disabled && (
        <div className="mt-4 text-center">
          <p className="text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-lg p-3 border dark:border-gray-700">
            💡 <span className="font-medium">Tip:</span> Make sure the QR code
            is clearly visible and well-lit in the image
          </p>
        </div>
      )}
    </div>
