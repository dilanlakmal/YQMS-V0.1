          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-gray-500 uppercase bg-gray-50 dark:bg-gray-700/50 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
              <tr>
                ...
                <th className="px-2 py-3 text-center">Measurement</th>
                <th className="px-2 py-3 text-center">Header</th>
                <th className="px-2 py-3 text-center">Photos</th>
                <th className="px-4 py-3 min-w-[200px]">Defect Categories</th>
                {/* New Columns */}
                <th className="px-2 py-3 text-center">Line</th>
                <th className="px-2 py-3 text-center">Table</th>
                <th className="px-2 py-3 text-center">Colors</th>
                <th className="px-2 py-3 text-center">Insp. Method</th>
                <th className="px-2 py-3 text-center">Insp. Qty</th>
                {/* End New Columns */}
                <th className="px-2 py-3 text-center">Q.Plan</th>
                <th className="px-2 py-3 text-center">Conclusion</th>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-3xl flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar">
              ...
              >
                ...
                {/* Settings Grid - 4 Columns for better fit */}
