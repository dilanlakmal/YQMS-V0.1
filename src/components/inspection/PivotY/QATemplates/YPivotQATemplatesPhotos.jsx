...
//   // Store images with their edit history: { sectionId_itemNo_index: { url, history, imgSrc } }
...
//       itemNo,
//       imageIndex,
//       existingData // Contains { imgSrc, history } if editing existing
//     });
...
//         ...prev,
//         [key]: {
//           url: imageDataUrl, // Final rendered image
...
//   const editExistingImage = (sectionId, itemNo, imageIndex) => {
//     const key = `${sectionId}_${itemNo}_${imageIndex}`;
...
//                                 onClick={() =>
//                                   editExistingImage(section._id, item.no, index)
//                                 }
//                               >
//                                 <img
//                                   src={data.url}
...
// const ImageEditorModal = ({ mode, existingData, onSave, onCancel }) => {
//   const editorRef = useRef(null);
//   const [editorReady, setEditorReady] = useState(false);

//   const handleSaveClick = () => {
//     const canvas = document.querySelector("#image-editor-canvas");
//     const historyData = window.imageEditorHistory || []; // Get from global or ref
//     const originalImg = window.imageEditorOriginalSrc || null;

//     if (canvas) {
//       const imageDataUrl = canvas.toDataURL("image/png");
//       onSave(imageDataUrl, historyData, originalImg);
//     }
//   };

//   return (
//     <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4 animate-fadeIn">
//       <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-hidden border border-gray-200 dark:border-gray-700 flex flex-col">
//         {/* Modal Header - Compact */}
//         <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-2.5 sm:p-3 flex items-center justify-between flex-shrink-0 border-b border-white/10">
//           <div className="flex items-center gap-2">
