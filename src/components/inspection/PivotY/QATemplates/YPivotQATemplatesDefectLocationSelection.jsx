...
//   // Open image editor for main images
//   const openImageEditor = (uniqueId, mode) => {
//     setEditingLocationId(uniqueId);
...
//     if (isAdditionalImage && editingPcsNo !== null) {
//       // Save to piece's additional images
//       setSelectedLocations((prev) =>
//         prev.map((item) => {
//           if (item.uniqueId === editingLocationId) {
//             const newPositions = item.positions.map((pos) => {
...
//       );
//     } else {
//       // Save to location's main images
//       setSelectedLocations((prev) =>
//         prev.map((item) => {
//           if (item.uniqueId === editingLocationId) {
//             const existingImages = item.images || [];
...
//                   <div
//                     key={img.id}
//                     className="relative w-14 h-14 rounded-lg overflow-hidden border-2 border-gray-200 group"
//                   >
//                     <img
//                       src={img.editedImgSrc || img.imgSrc}
//                       alt={`Image ${idx + 1}`}
...
//                       <X className="w-3 h-3" />
//                     </button>
//                     <span className="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-[7px] text-center">
//                       {idx + 1}
//                     </span>
//                   </div>
//                 ))}
...
//                 {(item.images?.length || 0) < item.qty && (
//                   <div className="w-14 h-14 rounded-lg border-2 border-dashed border-gray-300 flex flex-col items-center justify-center gap-0.5 bg-gray-50 hover:border-indigo-400 hover:bg-indigo-50 transition-colors">
//                     <div className="flex gap-0.5">
//                       <button
//                         onClick={() => openImageEditor(item.uniqueId, "camera")}
//                         className="p-1.5 rounded bg-white border border-gray-200 hover:border-indigo-300"
//                         title="Camera"
//                       >
...
//               {imageWarning && (
//                 <div className="flex items-center gap-1 text-amber-600 bg-amber-50 rounded px-2 py-1">
//                   <AlertCircle className="w-3 h-3 flex-shrink-0" />
//                   <span className="text-[9px] font-medium">{imageWarning}</span>
//                 </div>
//               )}
//             </div>
//           </div>
