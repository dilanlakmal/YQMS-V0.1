...
// Added props: forcedProductTypeId, onSelectionChange, initialSelections
const YPivotQATemplatesDefectLocationSelection = ({
  ...
  useEffect(() => {
    if (forcedProductTypeId && configurations.length > 0) {
      // Find config that matches the productTypeId
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-20">
      ...
      {currentConfig ? (
        ...
        // Only show empty state if NO forced product type
        !forcedProductTypeId && (
