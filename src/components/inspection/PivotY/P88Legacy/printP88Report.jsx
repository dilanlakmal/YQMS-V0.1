...
const PrintP88Report = () => {
  ...
  const checkAvailableSpace = async (path = "") => {
    try {
      ...
      const endpoint =
        downloadMode === "single" ? "check-space" : "check-bulk-space";
  ...
  const handleConfirmDownload = async () => {
    ...
    try {
      const apiBaseUrl = import.meta.env.VITE_API_BASE_URL || "";
      const endpoint =
        downloadMode === "single" ? "print-report" : "download-bulk-reports";
              ...
              <div className="bg-blue-50 p-3 rounded-lg mb-3">
                ...
                <ul className="text-sm space-y-1">
                  ...
                  {spaceInfo?.recordCount && (
                    <li>
                      <strong>Reports to Download:</strong>{" "}
                      {spaceInfo.recordCount}
                    </li>
                  )}
                </ul>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="text-sm space-y-1">
                        ...
                        <li>
                          <strong>Location:</strong> {spaceInfo.path}
                        </li>
                      </ul>
                      <p
