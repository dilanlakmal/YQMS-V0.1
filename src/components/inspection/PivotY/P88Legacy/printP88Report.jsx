...
const PrintP88Report = () => {
    ...
    useEffect(() => {
      ...
      getRecordStats();
  }, [includeDownloaded, startDate, endDate, factoryName, poNumber, styleNumber]);

    useEffect(() => {
        // Remove date requirement - fetch stats whenever any filter changes
        getDateFilteredStats();
    }, [startDate, endDate, factoryName, poNumber, styleNumber, includeDownloaded]);
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(`❌ Failed to fetch filtered options: ${response.status} ${response.statusText}`);
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-blue-100 text-sm">Download inspection reports with flexible filtering</p>
                            </div>
                        </div>
                    </div>
                        ...
                        {dateFilteredStats && (
                            <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600">
                                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center space-x-2">
                                    ...
                                    <span>
                                        {(startDate || endDate || factoryName || poNumber || styleNumber) 
                                            ? 'Filtered Records' 
                                            : 'All Records'
                                        }
                                    </span>
                        ...
                        {dateFilteredStats && dateFilteredStats.totalRecords === 0 && (
                            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
                                ...
                                <p className="text-gray-600 mb-4">
                                    No inspection reports match your current filter criteria. Try adjusting your filters or clearing them to see all available reports.
                                </p>
                                <button
                                    onClick={() => {
                                        setStartDate('');
                                ...
                                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-blue-600 font-medium">{factoryName || 'All Suppliers'}</div>
                                        </div>
                                        <div>
                                            <span className="font-medium text-gray-700">PO Number:</span>
                                            <div className="text-blue-600 font-medium">{poNumber || 'All PO Numbers'}</div>
                                        </div>
                                        <div>
                                            <span className="font-medium text-gray-700">Style:</span>
                                            <div className="text-blue-600 font-medium">{styleNumber || 'All Styles'}</div>
                                        </div>
                                        <div>
