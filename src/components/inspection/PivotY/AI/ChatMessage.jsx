...
//   return (
//     <div
//       className={`flex gap-4 p-4 sm:p-6 ${isUser ? "" : "bg-gray-50 dark:bg-gray-800/50"}`}
//     >
//       <div
//         className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${isUser ? "bg-gray-200 dark:bg-gray-700" : "bg-gradient-to-br from-indigo-500 to-purple-600"}`}
//       >
//         {isUser ? (
...
//           )}
//         </div>
//         <div className="prose dark:prose-invert max-w-none text-sm sm:text-base text-gray-700 dark:text-gray-300 whitespace-pre-wrap leading-relaxed">
//           {message.content}
//         </div>
//       </div>
//     </div>
