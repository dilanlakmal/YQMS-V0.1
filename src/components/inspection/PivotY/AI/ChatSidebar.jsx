...
//   if (!isOpen) {
//     return (
//       <div className="hidden md:flex flex-col items-center py-4 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 w-16 h-full transition-all">
//         <button
...
//         </button>
//         <div className="mt-4 w-full h-px bg-gray-200 dark:bg-gray-800" />
//         <button
//           onClick={onNewChat}
//           className="mt-4 p-3 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-xl hover:shadow-md transition-all"
//           title="New Chat"
//         >
//           <Plus size={24} />
//         </button>
...
//   return (
//     <div className="flex flex-col w-full md:w-72 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 h-full transition-all z-20 absolute md:relative">
//       {/* Header */}
//       <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
//         <h3 className="font-bold text-gray-800 dark:text-white">Chats</h3>
//         <button
//           onClick={() => setIsOpen(false)}
//           className="p-1.5 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg md:block hidden"
//         >
...
//         <button
//           onClick={onNewChat}
//           className="flex items-center gap-2 w-full px-4 py-3 bg-gray-100 dark:bg-gray-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-xl font-bold transition-all border border-transparent hover:border-indigo-200 dark:hover:border-indigo-800"
//         >
//           <Plus size={18} />
//           <span>New Chat</span>
//         </button>
...
//                   className="w-full bg-white dark:bg-gray-950 border border-indigo-300 rounded px-1 py-0.5 text-xs focus:outline-none"
//                   autoFocus
//                 />
//                 <button
...
//                   }}
//                   className={`p-1 rounded-full opacity-0 group-hover:opacity-100 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all ${menuOpenId === chat._id ? "opacity-100" : ""}`}
//                 >
...
//                 {/* Dropdown Menu */}
//                 {menuOpenId === chat._id && (
//                   <div className="absolute right-0 top-6 w-32 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden animate-fadeIn">
//                     <button
//                       onClick={(e) => startEdit(e, chat)}
//                       className="flex items-center gap-2 w-full px-3 py-2 text-xs hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"
//                     >
...
//                       }}
//                       className="flex items-center gap-2 w-full px-3 py-2 text-xs hover:bg-red-50 dark:hover:bg-red-900/30 text-red-600"
//                     >
