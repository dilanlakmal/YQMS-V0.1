...
// // ─── Constants ────────────────────────────────────────────────────────────────
// const PAGE_SIZE = 10; // defects per page
// const AUTO_INTERVAL = 10000; // 10s
// const DATE_COL_W = 72; // px per date column
// const NAME_COL_W = 220; // px for defect name column
...
//       {open && (
//         <div className="absolute right-0 top-full mt-1 w-72 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl z-50 overflow-hidden animate-fadeIn">
//           {/* Search */}
...
//   // Defect name filter (multi-select)
...
//           bg: "bg-green-50  dark:bg-green-900/20",
//         },
//         { dot: "", label: "No data", bg: "bg-gray-50   dark:bg-gray-800/40" },
//       ].map(({ dot, label, bg }) => (
//         <div key={label} className="flex items-center gap-1.5">
//           <div
//             className={`w-3 h-3 rounded-sm ${bg} border border-gray-200 dark:border-gray-700 flex items-center justify-center`}
//           >
...
//   return (
//     <div
//       className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden animate-fadeIn"
...
//             style={{ minWidth: NAME_COL_W + dates.length * DATE_COL_W }}
//           >
...
//                 <th
//                   className="sticky left-0 z-30 bg-gray-100 dark:bg-gray-900 border-r-2 border-b border-gray-200 dark:border-gray-700 px-3 py-2 text-left font-bold text-gray-600 dark:text-gray-300 uppercase text-[10px] tracking-wider"
...
//                     Defect Name
//                     {allRows.length > 0 && (
//                       <span className="ml-1 text-[9px] font-bold bg-indigo-100 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 px-1.5 py-0.5 rounded-full">
//                         {allRows.length}
//                       </span>
//                     )}
//                   </div>
...
//                     <th
//                       key={date}
//                       className="bg-gray-100 dark:bg-gray-900 border-r border-b border-gray-200 dark:border-gray-700 px-1 py-1.5 text-center font-bold text-gray-500 dark:text-gray-400"
...
//                 {/* Total column */}
//                 <th
//                   className="bg-gray-100 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-2 py-1.5 text-center font-bold text-gray-500 dark:text-gray-400 text-[10px] uppercase tracking-wider"
//                   style={{ minWidth: 56 }}
//                 >
//                   Total
//                 </th>
...
//                   </td>
//                 ))}
//                 <td className="border-b-2 border-gray-200 dark:border-gray-700 px-2 py-1 text-center text-[9px] font-bold text-indigo-500">
//                   {Object.values(dateSamples)
//                     .reduce((a, b) => a + b, 0)
//                     .toLocaleString()}
//                 </td>
//               </tr>
...
//                     ${rowIdx % 2 === 0 ? "bg-white dark:bg-gray-800" : "bg-gray-50/50 dark:bg-gray-800/60"}
//                   `}
//                 >
//                   {/* Sticky defect name */}
//                   <td
//                     className={`
//                       sticky left-0 z-10 border-r-2 border-b border-gray-100 dark:border-gray-700
//                       px-3 py-2 font-semibold text-gray-700 dark:text-gray-200 truncate
//                       ${rowIdx % 2 === 0 ? "bg-white dark:bg-gray-800" : "bg-gray-50/50 dark:bg-gray-800/60"}
//                     `}
...
//                             <span
//                               className={`text-[10px] font-black leading-none ${cs.text}`}
//                             >
//                               {cell.rate.toFixed(1)}%
//                             </span>
...
//                           </div>
//                         ) : (
//                           <span className={`text-[9px] ${cs.text}`}>—</span>
//                         )}
//                       </td>
//                     );
//                   })}
...
//                   {/* Total qty */}
//                   <td className="border-b border-gray-100 dark:border-gray-700 px-2 py-2 text-center">
...
//               {/* Empty padding rows to keep table height stable */}
//               {pageRows.length < PAGE_SIZE &&
//                 Array.from({ length: PAGE_SIZE - pageRows.length }).map(
//                   (_, i) => (
//                     <tr key={`pad-${i}`} className="bg-white dark:bg-gray-800">
//                       <td
//                         className="sticky left-0 z-10 bg-white dark:bg-gray-800 border-r-2 border-b border-gray-100 dark:border-gray-700 px-3 py-2"
//                         style={{ height: 36 }}
//                       />
//                       {dates.map((date) => (
//                         <td
...
//                     : "w-2 h-2 bg-gray-300 dark:bg-gray-600 hover:bg-indigo-300"
//                 }`}
//               />
//             ))}
//           </div>
            ...
            <tbody>
              {pageRows.map((row, rowIdx) => (
                ...
                >
                  {/* Sticky name */}
                  <td
                    className={`sticky left-0 z-10 border-r-2 border-b border-gray-100 dark:border-gray-700 px-3 py-2 font-semibold text-gray-700 dark:text-gray-200 ${rowIdx % 2 === 0 ? "bg-white dark:bg-gray-800" : "bg-gray-50/50 dark:bg-gray-800/60"}`}
                    style={{ maxWidth: NAME_COL_W }}
                    title={row.defectKey}
                  >
                    <span className="block truncate text-[11px]">
