...
const ProductionCharts = ({ dbData, summary }) => (
  <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
    <div className="lg:col-span-8 bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] shadow-sm border border-slate-200 dark:border-gray-800">
      <h3 className="text-xl font-black mb-8 flex items-center gap-3 text-slate-800 dark:text-white">
        <TrendingUp className="text-blue-600" /> DAILY WASHING QTY TREND
      </h3>
    ...
    <div className="lg:col-span-4 bg-gradient-to-br from-blue-600 to-indigo-800 p-8 rounded-[2.5rem] text-white shadow-xl flex flex-col justify-between">
      <div>
        <h3 className="text-xl font-bold flex items-center gap-2 mb-2">
          <Percent size={20} /> Measurement Quality{" "}
        </h3>
        <p className="text-blue-100 text-sm">
          Overall Pass Rate for selected period
        </p>
      </div>
      <div className="flex flex-col items-center py-8">
        ...
        <div className="text-xs font-bold bg-white/20 px-4 py-1.5 rounded-full uppercase tracking-widest">
          {" "}
          Overall Measurement Pass Rate
        </div>
      </div>
      <div className="space-y-4">
        <div className="flex justify-between text-xs font-bold border-b border-white/10 pb-2">
          ...
          <span className="text-amber-400">
            {summary.totalDefects?.toLocaleString()} PCS
          </span>
        </div>
