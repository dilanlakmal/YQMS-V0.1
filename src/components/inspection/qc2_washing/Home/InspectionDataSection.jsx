                  ...
                  >
                    ...
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">
                      <input
                        ...
                        checked={item.na}
                        onChange={(e) =>
                          handleInspectionChange(index, "na", e.target.checked)
                        }
                      />
                    </td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-2 dark:text-white">
              ...
              <table>
                ...
                <tbody>
                  {defectData
                    .filter(
                      (item) =>
                        (item.parameter || item.parameterName) !== "Effect"
                    )
                    .map((item, index) => {
                      const paramName =
                        ...
                        <tr key={index}>
                          ...
                          <td className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">
                            <input
                              ...
                              checked={isOk}
                              onChange={() =>
                                handleDefectChange(index, "ok", true)
                              }
                            />
                          </td>
                          {/* No Radio */}
                          <td className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">
                            <input
                              ...
                              checked={isNo}
                              onChange={() =>
                                handleDefectChange(index, "no", true)
                              }
                            />
                          </td>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    const currentCheckedQty =
                                      item.checkedQty !== undefined &&
                                      item.checkedQty !== null
                          ...
                          <td
                            className={`border border-gray-300 dark:border-gray-600 px-4 py-2 text-center ${
                              isOk ? "text-gray-400" : "dark:text-white"
                            }`}
                          >
                            {passRate}
                          </td>
