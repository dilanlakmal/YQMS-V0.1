                ...
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-4 border border-purple-200 dark:border-purple-800 hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-xs font-medium text-purple-600 dark:text-purple-300 uppercase tracking-wide mb-1">
                          Total Pcs
                        </p>
                  ...
                  <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 dark:from-cyan-900/20 dark:to-cyan-800/20 rounded-xl p-4 border border-cyan-200 dark:border-cyan-800 hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-xs font-medium text-cyan-600 dark:text-cyan-300 uppercase tracking-wide mb-1">
                          Wash Qty
                        </p>
                    ...
                    {defectsByPc.length > 0 ? (
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {defectsByPc.map((pcDefect, index) => (
                          <div
                            key={index}
                            className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 border border-red-200 dark:border-red-800 rounded-xl p-5 hover:shadow-md transition-shadow"
                          >
                            ...
                            {pcDefect.pcDefects &&
                              pcDefect.pcDefects.length > 0 && (
                                <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                                  {pcDefect.pcDefects.map(
                                    (defect, defectIndex) => (
                                      <div
                                        key={defectIndex}
                                        className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-red-200 dark:border-red-700 hover:shadow-sm transition-shadow"
                                      >
                                ...
                                {reportData.defectDetails.additionalImages.map(
                                  (img, imgIndex) => {
                                    ...
                                    return (
                                      <div
                                        key={imgIndex}
                                        className="w-full h-32 bg-gray-100 dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-600 overflow-hidden"
                                      >
                                        {imageUrl ? (
                                          <img
                                            src={imageUrl}
                        ...
                        <div className="flex items-center justify-center space-x-3">
                          ...
                          <div className="text-center">
                            ...
                            <p className="text-sm text-green-600 dark:text-green-300">
                              No defects found in this inspection
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                return (
                  <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-6">
                    ...
                    <div className="space-y-6">
                      ...
                      {inspectionDetails.checkedPoints &&
                        inspectionDetails.checkedPoints.length > 0 && (
                          <div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                              {inspectionDetails.checkedPoints.map(
                                (point, index) => (
                                  <div
                                    key={index}
                                  ...
                                  >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                      ...
                                      <div>
                                        ...
                                        {/* Comparison Images */}
                                        {point.comparison &&
                                          point.comparison.length > 0 && (
                                            <div>
                                              <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">
                                                Comparison Images:
                                              </p>
                                              <div className="grid grid-cols-2 gap-2">
                                                {point.comparison.map(
                                                  (img, imgIndex) => {
                                                    const imageUrl =
                                                      getImageUrl(img);
                                                    ...
                                                    return (
                                                      <div
                                                        key={imgIndex}
                                                        className="w-full h-20 bg-gray-100 dark:bg-gray-600 rounded border border-gray-200 dark:border-gray-600 overflow-hidden"
                                                      >
                                                        {imageUrl ? (
                                                          <img
                                                            src={imageUrl}
                        ...
                        inspectionDetails.parameters.length > 0 && (
                          <div>
                            ...
                            <div className="space-y-4">
                              {inspectionDetails.parameters.map(
                                (param, index) => (
                                  <div
                                    key={index}
                                    className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-xl p-5 hover:shadow-md transition-shadow"
                      ...
                      {/* Machine Processes */}
                      {inspectionDetails.machineProcesses &&
                        inspectionDetails.machineProcesses.length > 0 && (
                          <div>
                            ...
                            <div className="space-y-4">
                              {inspectionDetails.machineProcesses.map(
                                (machine, index) => (
                                  <div
                                    key={index}
                                    className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-xl p-5 hover:shadow-md transition-shadow"
              ...
              {reportData.measurementDetails?.measurementSizeSummary && (
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {reportData.measurementDetails.measurementSizeSummary.map(
                      (sizeSummary, index) => (
                        <div
                          key={index}
                          className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-5 border border-purple-200 dark:border-purple-800 hover:shadow-md transition-shadow"
                        >
                          <div className="flex items-center space-x-3 mb-4">
                            <div className="bg-purple-500 p-2 rounded-lg">
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-orange-100 dark:border-orange-800">
                              <div className="flex items-center justify-between">
                                ...
                                <span className="font-bold text-orange-800 dark:text-orange-200">
                                  {sizeSummary.plusToleranceFailCount}
                                </span>
                              </div>
                            </div>
                            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-amber-100 dark:border-amber-800">
                              <div className="flex items-center justify-between">
                                ...
                                <span className="font-bold text-amber-800 dark:text-amber-200">
                                  {sizeSummary.minusToleranceFailCount}
                                </span>
                              </div>
                            </div>
                          </div>
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-6">
                  ...
                  <div className="space-y-6">
                    {Object.entries(
                      ...
                      <div
                        key={size}
                        className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-5 border border-blue-200 dark:border-blue-800 hover:shadow-md transition-shadow"
                      >
                        <div className="flex items-center space-x-3 mb-4">
                          <div className="bg-blue-500 p-2 rounded-lg">
                            <Ruler className="w-4 h-4 text-white" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {chartData.measurements?.map((measurement, index) => (
                            <div
                              key={index}
                              className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-600 hover:shadow-sm transition-shadow"
                            >
                              <div className="flex justify-between items-center mb-3">
                                <div className="flex items-center space-x-2">
                  ...
                  <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-6">
                    ...
                    <div className="space-y-8">
                      ...
                      {(() => {
                        ...
                        return primaryData.measurementDetails.measurement.map(
                          (afterSizeData, sizeIndex) => {
                            const beforeSizeData =
                              secondaryData.measurementDetails.measurement.find(
                                ...
                                >
                                  <div className="flex items-center space-x-3 mb-4">
                                    ...
                                    <h4 className="text-lg font-bold text-yellow-800 dark:text-yellow-200">
                                      Size: {afterSizeData.size} - No Comparison
                                      Data Available
                                    </h4>
                                  </div>
                                  <p className="text-sm text-yellow-700 dark:text-yellow-300">
                                    Comparison measurements for size{" "}
                                    {afterSizeData.size} were not found.
                                  </p>
                                </div>
                              );
                            }
                            ...
                            const displayAfterData =
                              reportData.before_after_wash === "Before Wash"
                                ? afterSizeData
                                : afterSizeData;
                            const displayBeforeData =
                              reportData.before_after_wash === "Before Wash"
                                ? beforeSizeData
                                : beforeSizeData;
                              ...
                              >
                                <div className="flex items-center space-x-3 mb-6">
                                  ...
                                  <h4 className="text-lg font-bold text-orange-800 dark:text-orange-200">
                                    Size: {displayAfterData.size} - Before vs
                                    After Comparison
                                  </h4>
                                  <div className="bg-orange-200 dark:bg-orange-700 px-3 py-1 rounded-full">
                                    <span className="text-xs font-medium text-orange-800 dark:text-orange-200">
                                      Before: {displayBeforeData.pcs.length} pcs
                                      | After: {displayAfterData.pcs.length} pcs
                                    </span>
                                  </div>
                                </div>
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
                                      {(() => {
                                        const afterMeasurementPoints =
                                          displayAfterData.pcs[0]
                                            ?.measurementPoints || [];

                                        return afterMeasurementPoints.map(
                                          (afterPoint, pointIndex) => {
                                            // Try to find matching point in before wash data by pointName
                                            const beforePoint =
                                              displayBeforeData.pcs[0]?.measurementPoints.find(
                                                (bp) =>
                                                  bp.pointName ===
                                                ...
                                                {displayAfterData.pcs.map(
                                                  (afterPc, pcIndex) => {
                                                    const afterMeasurement =
                                                      afterPc.measurementPoints.find(
                                                        (mp) =>
                                                          mp.pointName ===
                                                          afterPoint.pointName
                                                      );
                                                    const beforePc =
                                                      displayBeforeData.pcs[
                                                        pcIndex
                                                      ];
                                                    ...
                                                    const afterValue =
                                                      afterMeasurement?.measured_value_fraction ||
                                                      "N/A";
                                                    const beforeValue =
                                                      beforeMeasurement?.measured_value_fraction ||
                                                      "N/A";
                                                    const afterPass =
                                                    ...
                                                    return (
                                                      <td
                                                        key={pcIndex}
                                                        className="px-2 py-3 text-center text-sm font-medium border-r border-gray-200 dark:border-gray-600"
                                                      >
                                                        <div className="grid grid-cols-3 gap-1">
                                                          {/* Before Wash Value */}
                                                          <div
                                                            className={`flex flex-col items-center justify-center space-y-1 p-2 rounded min-h-[60px] ${
                                                              beforeMeasurement
                                                                ? beforePass
                                                          ...
                                                          {/* Difference */}
                                                          <div
                                                            className={`flex flex-col items-center justify-center p-2 rounded min-h-[60px] bg-orange-50 dark:bg-orange-900/20 ${differenceColor}`}
                                                          >
                                ...
                                <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-blue-100 dark:border-blue-800">
                                    ...
                                    <div className="text-sm font-bold text-blue-800 dark:text-blue-200">
                                      ...
                                      {displayBeforeData.pcs.reduce(
                                        (total, pc) =>
                                          total + pc.measurementPoints.length,
                                        0
                                      )}
                                    </div>
                                  </div>
                                  ...
                                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-orange-100 dark:border-orange-800">
                                    ...
                                    <div className="text-sm font-bold text-orange-800 dark:text-orange-200">
                                      Before: {displayBeforeData.kvalue} |
                                      After: {displayAfterData.kvalue}
                                    </div>
                                  </div>
                                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-purple-100 dark:border-purple-800">
                                    ...
                                    <div className="text-sm font-bold text-purple-800 dark:text-purple-200">
                                      {displayBeforeData.before_after_wash} →{" "}
                                      {displayAfterData.before_after_wash}
                                    </div>
                                  </div>
                                </div>
                              </div>
