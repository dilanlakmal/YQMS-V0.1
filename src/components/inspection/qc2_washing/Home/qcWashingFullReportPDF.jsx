  ...
  React.useEffect(() => {
    ...
    const preloadAllImages = async () => {
      ...
      try {
        ...
        const addImageToCollection = (img, context = "") => {
          ...
          const generateEssentialKeys = (img) => {
            ...
            if (typeof img === "string") {
              ...
              const urlMatch = cleanImg.match(
                /(?:192\.167\.12\.85:5000|yqms\.yaikh\.com)(\/.*)/
              );
          ...
          essentialKeys.slice(0, 3).forEach((key) => {
            // Limit to 3 keys per image
        ...
        console.log(
          `📊 Memory usage - Cache: ${finalMemory.cacheSize}, Loading: ${finalMemory.loadingSize}, Active: ${finalMemory.activeSize}`
        );
