  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 mb-8 border border-gray-200 dark:border-gray-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-2">
        ...
        <div className="bg-blue-50 dark:bg-blue-700 border border-blue-200 dark:border-blue-600 rounded-lg p-4 text-center flex flex-col justify-between">
          <div>
            <div className="text-xl font-bold text-blue-800 dark:text-blue-200 mb-2">Checked PCs</div>
        ...
        <div className="bg-red-50 dark:bg-red-700 border border-red-200 dark:border-red-600 rounded-lg p-4 text-center">
          <div className="text-xl font-bold text-red-800 dark:text-red-200 mb-2">Rejected PCs</div>
        ...
        <div className="bg-purple-50 dark:bg-purple-700 border border-purple-200 dark:border-purple-600 rounded-lg p-4 text-center">
          <div className="text-xl font-bold text-purple-800 dark:text-purple-200 mb-2">Defect Count</div>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-700 border border-yellow-200 dark:border-yellow-600 rounded-lg p-4 text-center">
          ...
          <div className="text-4xl font-extrabold text-yellow-600 dark:text-yellow-400"> {Number(defectRatio).toFixed(1)} %</div>
        </div>
