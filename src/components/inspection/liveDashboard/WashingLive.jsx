    ...
    <div className="group relative bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-6 shadow-lg dark:shadow-gray-900/50 rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl dark:hover:shadow-gray-900/70 hover:scale-105 transition-all duration-300 min-h-[180px]">
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="p-3 bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 text-white rounded-xl shadow-lg group-hover:shadow-xl transition-shadow duration-300">
...
const WashingLive = () => {
  ...
  const [chartDataType, setChartDataType] = useState("washing");
  ...
  const buildFilterQueryParams = (filtersToBuild) => {
    ...
    if (filtersToBuild.startDate)
      queryParams.startDate = normalizeDateStringForAPI(filtersToBuild.startDate);
  ...
  const fetchFilterOptions = useCallback(async (currentFilters = {}) => {
    ...
    try {
      ...
      if (currentFilters.startDate)
        queryParamsForFilters.startDate = normalizeDateStringForAPI(currentFilters.startDate);
      if (currentFilters.endDate)
        queryParamsForFilters.endDate = normalizeDateStringForAPI(currentFilters.endDate);
    ...
    async (filters = {}, page = 1) => {
      ...
      try {
        ...
        if (filters.startDate)
          displayableFilters["Start Date"] = normalizeDateStringForAPI(filters.startDate);
        if (filters.endDate)
          displayableFilters["End Date"] = normalizeDateStringForAPI(filters.endDate);
        if (filters.moNo)
          displayableFilters["MO No"] = filters.moNo.label;
  ...
  const selectStyles = {
    control: (provided, state) => ({
      ...
      boxShadow: state.isFocused ? "0 0 0 3px rgba(59, 130, 246, 0.1)" : "0 1px 3px 0 rgb(0 0 0 / 0.1)",
      borderWidth: "2px",
  ...
  const datePickerClass =
    "w-full p-3 border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm h-[42px] transition-all duration-200 hover:border-blue-400 dark:hover:border-blue-500";
  ...
  const hourlyBarChartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: `Hourly ${chartDataType === "washing" ? "Washing Qty" : "Bundle Count"}`,
  ...
  const preparedHourlyChartData = {
    ...
    datasets: [
      {
        label: chartDataType === "washing" ? "Total Washing Qty" : "Total Bundles",
        data: hourlyChartData.map((d) =>
          chartDataType === "washing" ? d.totalWashingQty : d.totalBundles
        ),
        backgroundColor: chartDataType === "washing"
          ? (darkMode ? "rgba(96, 165, 250, 0.8)" : "rgba(59, 130, 246, 0.8)")
          : (darkMode ? "rgba(52, 211, 153, 0.8)" : "rgba(16, 185, 129, 0.8)"),
        borderColor: chartDataType === "washing"
          ? (darkMode ? "rgba(96, 165, 250, 1)" : "rgba(59, 130, 246, 1)")
          : (darkMode ? "rgba(52, 211, 153, 1)" : "rgba(16, 185, 129, 1)"),
        borderWidth: 2,
        borderRadius: 8,
        borderSkipped: false,
      }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <button
            ...
            className="group flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-700 dark:to-blue-800 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 dark:hover:from-blue-800 dark:hover:to-blue-900 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
          >
          ...
          <div className="mb-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center">
                <FilterIcon size={20} className="mr-2 text-blue-600 dark:text-blue-400" />
                Filter Options
              </h3>
            </div>
            ...
            <div className="p-6">
                  ...
                  return (
                    <div key={field.label} className="space-y-2">
                      <label className="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300">
                        <IconComponent size={16} className="mr-2 text-blue-600 dark:text-blue-400" />
                        {field.label}
                      </label>
                      {field.type === "date" ? (
                        <DatePicker
              ...
              {Object.keys(appliedFiltersForDisplay).length > 0 && (
                <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-xl border border-blue-200 dark:border-blue-700">
                  <h4 className="text-sm font-semibold text-blue-800 dark:text-blue-300 mb-2">Applied Filters:</h4>
          ...
          <>
                ...
                <div className="mb-6 flex flex-wrap items-center gap-3">
                  <div className="flex items-center space-x-3">
                    <button
                      ...
                      className="flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 text-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105"
                    >
                            ...
                            {Object.values(visibleCols).filter((v) => v).length > 0 && (
                              <div className="flex justify-around mt-2 text-[10px] font-medium text-gray-600 dark:text-gray-400 space-x-1">
                                {visibleCols.totalWashingQty && (
                                  <span className="bg-blue-100 dark:bg-blue-800 text-blue-800 dark:text-blue-200 px-2 py-1 rounded-md">Wash</span>
                                )}
                                ...
                                {visibleCols.totalRewashQty && (
                                  <span className="bg-red-100 dark:bg-red-800 text-red-800 dark:text-red-200 px-2 py-1 rounded-md">Rewash</span>
                                )}
                              </div>
                            )}
                          </th>
            ...
            <div className="mb-10 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
              <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center">
                    <BarChart3 size={24} className="mr-3 text-blue-600 dark:text-blue-400" />
                    Hourly Performance
                  </h2>
              ...
              <div className="p-6">
                {isLoadingHourlyChart ? (
                  ...
                  <div className="h-96">
                    <Bar options={hourlyBarChartOptions} data={preparedHourlyChartData} />
                  </div>
                ) : (
                  <div className="h-96 flex flex-col items-center justify-center text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-lg font-medium">No hourly data available</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
              <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center">
                  <Package size={24} className="mr-3 text-blue-600 dark:text-blue-400" />
                ...
                <div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-t border-gray-200 dark:border-gray-600">
                  <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-blue-50 dark:bg-blue-900/50 border border-blue-200 dark:border-blue-700 rounded-lg">
