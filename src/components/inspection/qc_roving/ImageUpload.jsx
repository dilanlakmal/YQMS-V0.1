...
const ImageUpload = ({
  ...
  const getTypeColor = () => {
    switch (type) {
      case "defect":
        return "border-red-300 bg-red-50 text-red-700 hover:bg-red-100 hover:border-red-400";
      case "measurement":
        return "border-blue-300 bg-blue-50 text-blue-700 hover:bg-blue-100 hover:border-blue-400";
      case "accessory":
        return "border-green-300 bg-green-50 text-green-700 hover:bg-green-100 hover:border-green-400";
      default:
        return "border-gray-300 bg-gray-50 text-gray-700 hover:bg-gray-100 hover:border-gray-400";
    }
  };
