...
const LineWorkers = ({ onWorkerCountUpdated }) => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-semibold mb-6 text-gray-700">{t('lineWorkersDb.title', "Inline Worker Summary by Line")}</h2>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-100">
            ...
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                ...
                <input
                  ...
                  placeholder={t('lineWorkersDb.filterPlaceholderLineNo', "Filter by Line No...")}
          ...
          {filteredLineSummaries.length > 0 ? (
              ...
              <tr>
                ...
                {t('lineWorkersDb.noResults', "No line summaries found matching your criteria.")}
                </td>
              </tr>
            )}
          </tbody>
