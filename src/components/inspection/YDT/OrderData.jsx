          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
            <div className="flex-1">
              <h1 className="text-xl sm:text-2xl font-bold text-white mb-2">
                ...
                <span className="text-teal-100">Yorkmars (Cambodia) Garment MFG. Co. Ltd.</span>
              </h1>
            </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg p-4 border border-teal-200 min-h-[80px] flex items-center justify-center">
                <span className="text-2xl font-bold text-teal-700">{/* Total quantity */}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                  <th className="border border-gray-300 px-3 py-2 text-center text-xs font-semibold text-gray-700 uppercase">
                    SHIPMENT LOT
                  </th>
                  <th className="border border-gray-300 px-3 py-2 text-center text-xs font-semibold text-gray-700 uppercase">
                    EX FTY DATE
              ...
              <tbody>
                {[1, 2, 3, 4].map((lot) => (
                  <tr key={lot} className="hover:bg-gray-50 transition-colors">
                    <td className="border border-gray-300 px-3 py-2 text-center">
                      <div className="bg-gray-100 rounded px-2 py-1 text-sm font-semibold min-h-[32px] flex items-center justify-center">
                        {/* Shipment lot */}
                      </div>
                    </td>
                    <td className="border border-gray-300 px-3 py-2 text-center">
                      <div className="bg-gray-50 rounded px-2 py-1 text-sm min-h-[32px] flex items-center justify-center">
                        {/* Ex factory date */}
                      </div>
                    </td>
                    <td className="border border-gray-300 px-3 py-2 text-center">
                      <div className="bg-green-50 rounded px-2 py-1 text-sm font-semibold text-green-700 min-h-[32px] flex items-center justify-center">
                        {/* Quantity */}
                      </div>
                    </td>
                  </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.label}>
                ...
                <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 min-h-[60px] flex items-center">
                  {/* Processing details */}
                </div>
              </div>
            ))}
