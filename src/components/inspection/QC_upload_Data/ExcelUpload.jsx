          ...
          className={`relative group border-2 border-dashed rounded-xl p-8 cursor-pointer transition-all duration-300 ${
            fileName
              ...
              : `border-gray-300 dark:border-gray-600 hover:border-${
                  type === "output" ? "blue" : "red"
                }-400 dark:hover:border-${
                  type === "output" ? "blue" : "red"
                }-500 hover:bg-${
                  type === "output" ? "blue" : "red"
                }-50 dark:hover:bg-${type === "output" ? "blue" : "red"}-900/20`
          }`}
          onClick={handleClick}
          tabIndex={0}
          role="button"
        ...
        >
          ...
          <div className="text-center">
            {fileName ? (
              ...
              <>
                <div
                  className={`w-16 h-16 mx-auto mb-4 bg-${
                    type === "output" ? "blue" : "red"
                  }-100 dark:bg-${
                    type === "output" ? "blue" : "red"
                  }-800 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                >
                  <span className="text-2xl">📁</span>
                </div>
                ...
                <div
                  className={`inline-flex items-center px-6 py-3 bg-gradient-to-r from-${
                    ...
                    type === "output" ? "blue" : "red"
                  }-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300`}
                >
            ...
            {tableData.length > 0 && !showPreview && (
              <button
                className={`flex items-center px-4 py-2 bg-gradient-to-r from-${
                  type === "output" ? "blue" : "red"
                }-500 to-${type === "output" ? "blue" : "red"}-600 dark:from-${
                  type === "output" ? "blue" : "red"
                }-600 dark:to-${
                  type === "output" ? "blue" : "red"
                }-700 text-white rounded-lg font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300`}
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100 text-sm">
                      First {Math.min(PREVIEW_ROW_LIMIT, tableData.length)} of{" "}
