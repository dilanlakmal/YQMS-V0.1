        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              type="button"
              onClick={() =>
                !isCompleting && setIsReportTypeOpen(!isReportTypeOpen)
              }
            ...
            >
              <div className="flex items-center gap-2">
                <span
                  className={`text-lg ${isCompleting ? "text-gray-500 dark:text-gray-400" : "text-blue-600 dark:text-blue-400"}`}
                >
                  {reportTypeIcons && reportTypeIcons[formData.reportType]}
                </span>
                <span
                  className={`font-medium text-[12px] sm:text-[13px] tracking-tight truncate ${isCompleting ? "text-gray-600 dark:text-gray-400" : "text-gray-800 dark:text-gray-100"}`}
                >
                  {formData.reportType}
                  {isCompleting && (
                ...
                <div className="p-1.5 space-y-0.5">
                  {reportTypes
                    ...
                    .map((type) => (
                      ...
                      >
                        <span
                          className={`text-lg ${formData.reportType === type.val ? "text-blue-600 dark:text-blue-400" : "text-blue-500/70 group-hover:text-blue-600"}`}
                        >
                          {type.icon}
                        </span>
