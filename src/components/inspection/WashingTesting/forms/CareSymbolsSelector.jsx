...
const CARE_CATEGORIES = [
    ...
    options: [
      {
        ...
        items: [
          "machine-wash.png",
          "machine-wash-permanent-press.png",
          "machine-wash-delicate.png",
          "hand-wasing.png",
          "do-not-wash.png",
        ],
      },
      {
        ...
        items: [
          "water-temperature30.png",
          "water-temperature40.png",
          "water-temperature50.png",
        ],
      },
      {
        id: "temp-dots-lines",
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "non-chlorine",
        icon: "non-chlorine-bleach.png",
        items: ["non-chlorine-bleach.png"],
      },
      { id: "chlorine", icon: "chlorine.png", items: ["chlorine.png"] },
      {
        id: "do-not-bleach",
        icon: "not-bleach.png",
        items: ["not-bleach.png", "not-bleach1.png"],
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        items: [
          "tumble-dry.png",
          "tb-dry-normal-no-heat.png",
          "tb-dry-permanent-press-no-heat.png",
          "tb-dry-gentle-no-heat.png",
          "low-heat1.png",
          "medium-heat.png",
          "high-heat.png",
        ],
      ...
      {
        id: "tumble-low",
        icon: "tb-dry-gentle-low-heat.png",
        items: [
          "tb-dry-permanent-press-low-heat.png",
          "tb-dry-permanent-press-medium-heat.png",
          "tb-dry-gentle-low-heat.png",
        ],
      },
      {
        id: "tumble-medium",
        icon: "tb-dry-gentle-medium-heat.png",
        items: ["tb-dry-gentle-medium-heat.png"],
      },
      // { id: 'tumble-no-heat', icon: 'tb-dry-gentle-no-heat.png', items: [] },
      {
        id: "do-not-tumble",
        icon: "do-not-tumble-dry.png",
        items: ["do-not-tumble-dry.png"],
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "do-not-dry",
        icon: "do-not-dry34.png",
        items: ["do-not-dry34.png"],
      },
      ...
      { id: "line-dry", icon: "line-dry.png", items: ["line-dry.png"] },
      {
        id: "wring",
        icon: "Wring.png",
        items: ["Wring.png", "do-not-wring.png"],
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "iron-low",
        icon: "iron-low-temp.png",
        items: ["iron-low-temp.png"],
      },
      {
        id: "iron-medium",
        icon: "iron-medium-temp.png",
        items: ["iron-medium-temp.png"],
      },
      {
        id: "iron-high",
        icon: "iron-hight-temp.png",
        items: ["iron-hight-temp.png"],
      },
      {
        id: "do-not-iron",
        icon: "do-not-iron.png",
        items: ["do-not-iron.png"],
      },
...
const CareSymbolsSelector = ({
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className={`absolute z-50 mt-2 left-0 right-0 sm:left-auto sm:right-auto lg:left-0 lg:right-0 w-full max-w-[min(100vw-1rem,1200px)] lg:max-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 ${compact ? "sm:max-w-[520px]" : "sm:min-w-[520px] md:min-w-[700px] lg:min-w-[800px]"}`}
        >
          <div
            className={`overflow-y-auto overflow-x-hidden ${compact ? "p-2 max-h-[70vh]" : "p-3 sm:p-4 md:p-2 lg:p-4 max-h-[75vh] sm:max-h-[70vh]"}`}
          >
            <div
              className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 ${compact ? "gap-2" : "gap-3 sm:gap-4 md:gap-1.5 lg:gap-4"}`}
            >
              {CARE_CATEGORIES.map((cat) => (
                <div
                  key={cat.id}
                  className={`flex flex-col min-w-0 ${compact ? "gap-1" : "gap-2"}`}
                >
                  {/* Header */}
                  <div
                    className={`text-center border-b dark:border-gray-700 ${compact ? "pb-1" : "pb-2"}`}
                  >
                    <span
                      className={`font-bold text-gray-500 uppercase tracking-wider ${compact ? "text-[10px]" : "text-[10px] sm:text-xs md:text-[9px] lg:text-xs"}`}
                    >
                      {cat.label}
                    </span>
                  </div>
                  ...
                  <div
                    className={`flex flex-col items-center ${compact ? "gap-1.5 py-1" : "gap-3 py-2"}`}
                  >
                    {cat.options.map((opt, idx) => (
                      <div
                        key={idx}
                        className={`flex flex-col items-center w-full ${compact ? "gap-1" : "gap-2"}`}
                      >
          ...
          {/* Footer / clear */}
          <div
            className={`bg-gray-50 dark:bg-gray-700/50 border-t flex justify-between items-center gap-2 flex-wrap ${compact ? "p-2" : "p-2 sm:p-3"}`}
          >
            <span className="text-xs text-gray-500">
              Select one symbol per column
            </span>
            <button
              type="button"
              onClick={() => onChange({})}
