...
const HTTestingForm = ({
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (e) => {
      if (!e.target.closest(".fabric-dropdown-container"))
  ...
  const fabricOptions = Array.isArray(fabricContent)
    ? fabricContent.map(
        (f) =>
          `${f.percentageValue ?? ""}% ${f.fabricName ?? ""}`.trim() ||
          `${f.fabricName ?? "—"} (${f.percentageValue ?? "—"}%)`,
      )
    : [];
  const selectedFabricColors = Array.isArray(formData.fabricColor)
    ? formData.fabricColor
    : formData.fabricColor
      ? String(formData.fabricColor)
          .split(",")
          .map((s) => s.trim())
          .filter(Boolean)
      : [];
  ...
  React.useEffect(() => {
    ...
    let colorArr = Array.isArray(garmentColor)
      ? garmentColor
      : garmentColor
        ? [String(garmentColor).trim()].filter(Boolean)
        : [];
    if (
      colorArr.length === 0 &&
    ...
    if (colorArr.length > 0) {
      const hasFabricColor = Array.isArray(formData.fabricColor)
        ? formData.fabricColor.length > 0
        : formData.fabricColor && String(formData.fabricColor).trim() !== "";
      if (!hasFabricColor)
        handleInputChange(
          "fabricColor",
          fabricOptions.length > 0 ? colorArr : colorArr.join(", "),
        );
    }
  }, [
    season,
            ...
            <div className="relative fabric-dropdown-container">
              ...
              {fabricOptions.length > 0 ? (
                        ...
                        <div className="p-2">
                          ...
                          <div className="space-y-1">
                            {fabricOptions.map((label, index) => {
                              const isSelected =
                                selectedFabricColors.includes(label);
                              return (
                                <label
                                  key={index}
                ...
                <input
                  type="text"
                  value={
                    typeof formData.fabricColor === "string"
                      ? formData.fabricColor
                      : Array.isArray(formData.fabricColor)
                        ? formData.fabricColor.join(", ")
                        : ""
                  }
                  onChange={(e) =>
                    !isCompleting &&
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className="relative group ant-datepicker-container">
                <AntDatePicker
                  value={
                    formData.reportDate ? dayjs(formData.reportDate) : null
                  }
            ...
            <div>
              ...
              <TimePicker
                ...
                onChange={(date, dateString) =>
                  handleInputChange("time", dateString || "")
                }
                format="h:mm A"
                use12Hours
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("printPlacement", e.target.value)
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleInputChange("fabrication", e.target.value)
                }
                rows={2}
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleInputChange("testMethod", e.target.value)
                }
                rows={2}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white resize-vertical"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("detergents", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("heatTemperature", e.target.value)
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("washingTime", e.target.value)
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("washingPressure", e.target.value)
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("washingTemperature", e.target.value)
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
        ...
        <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorChangeFabric3 ||
                        PRINT_WASH_TEST_DEFAULTS.colorChangeFabric3
                      }
                      onChange={(e) =>
                        handleInputChange("colorChangeFabric3", e.target.value)
                      }
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorChangeFabric5 ||
                        PRINT_WASH_TEST_DEFAULTS.colorChangeFabric5
                      }
                      onChange={(e) =>
                        handleInputChange("colorChangeFabric5", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorChangeFabric10 ||
                        PRINT_WASH_TEST_DEFAULTS.colorChangeFabric10
                      }
                      onChange={(e) =>
                        handleInputChange("colorChangeFabric10", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorChangeFabric15 ||
                        PRINT_WASH_TEST_DEFAULTS.colorChangeFabric15
                      }
                      onChange={(e) =>
                        handleInputChange("colorChangeFabric15", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5"
                    />
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorStainingHT3 ||
                        PRINT_WASH_TEST_DEFAULTS.colorStainingHT3
                      }
                      onChange={(e) =>
                        handleInputChange("colorStainingHT3", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="5"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorStainingHT5 ||
                        PRINT_WASH_TEST_DEFAULTS.colorStainingHT5
                      }
                      onChange={(e) =>
                        handleInputChange("colorStainingHT5", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorStainingHT10 ||
                        PRINT_WASH_TEST_DEFAULTS.colorStainingHT10
                      }
                      onChange={(e) =>
                        handleInputChange("colorStainingHT10", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorStainingHT15 ||
                        PRINT_WASH_TEST_DEFAULTS.colorStainingHT15
                      }
                      onChange={(e) =>
                        handleInputChange("colorStainingHT15", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5"
                    />
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.appearanceAfterWashing3 ||
                        PRINT_WASH_TEST_DEFAULTS.appearanceAfterWashing3
                      }
                      onChange={(e) =>
                        handleInputChange(
                          "appearanceAfterWashing3",
                          e.target.value,
                        )
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.appearanceAfterWashing5 ||
                        PRINT_WASH_TEST_DEFAULTS.appearanceAfterWashing5
                      }
                      onChange={(e) =>
                        handleInputChange(
                          "appearanceAfterWashing5",
                          e.target.value,
                        )
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.appearanceAfterWashing10 ||
                        PRINT_WASH_TEST_DEFAULTS.appearanceAfterWashing10
                      }
                      onChange={(e) =>
                        handleInputChange(
                          "appearanceAfterWashing10",
                          e.target.value,
                        )
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.appearanceAfterWashing15 ||
                        PRINT_WASH_TEST_DEFAULTS.appearanceAfterWashing15
                      }
                      onChange={(e) =>
                        handleInputChange(
                          "appearanceAfterWashing15",
                          e.target.value,
                        )
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.peelOff3 || PRINT_WASH_TEST_DEFAULTS.peelOff3
                      }
                      onChange={(e) =>
                        handleInputChange("peelOff3", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="OK"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.peelOff5 || PRINT_WASH_TEST_DEFAULTS.peelOff5
                      }
                      onChange={(e) =>
                        handleInputChange("peelOff5", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="OK"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.peelOff10 || PRINT_WASH_TEST_DEFAULTS.peelOff10
                      }
                      onChange={(e) =>
                        handleInputChange("peelOff10", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="OK"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.peelOff15 || PRINT_WASH_TEST_DEFAULTS.peelOff15
                      }
                      onChange={(e) =>
                        handleInputChange("peelOff15", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="OK"
                    />
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.fading3 || PRINT_WASH_TEST_DEFAULTS.fading3
                      }
                      onChange={(e) =>
                        handleInputChange("fading3", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="OK"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.fading5 || PRINT_WASH_TEST_DEFAULTS.fading5
                      }
                      onChange={(e) =>
                        handleInputChange("fading5", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="OK"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.fading10 || PRINT_WASH_TEST_DEFAULTS.fading10
                      }
                      onChange={(e) =>
                        handleInputChange("fading10", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="OK"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.fading15 || PRINT_WASH_TEST_DEFAULTS.fading15
                      }
                      onChange={(e) =>
                        handleInputChange("fading15", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="OK"
                    />
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              onChange={(e) =>
                handleInputChange("testComments", e.target.value)
              }
              rows={2}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white resize-vertical"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleInputChange("beforeWashed", e.target.value)
                }
                rows={2}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white resize-vertical"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleInputChange("afterWashed", e.target.value)
                }
                rows={2}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white resize-vertical"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleInputChange("washingResult", e.target.value)
                }
                rows={2}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white resize-vertical"
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-3 min-h-[42px]">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border-2 transition-all duration-200 font-bold text-sm ${
                    formData.finalResults === "Accepted"
                ...
                >
                  <CheckCircle2
                    className={`w-4 h-4 shrink-0 ${formData.finalResults === "Accepted" ? "text-white" : "text-gray-300"}`}
                  />
                  Accepted
                </button>
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border-2 transition-all duration-200 font-bold text-sm ${
                    formData.finalResults === "Rejected"
                ...
                >
                  <XCircle
                    className={`w-4 h-4 shrink-0 ${formData.finalResults === "Rejected" ? "text-white" : "text-gray-300"}`}
                  />
                  Rejected
                </button>
              </div>
            ...
            <textarea
              ...
              placeholder={
                isCompleting
                  ...
                  : "Add any additional notes or comments about this HT test report..."
              }
            />
          </div>
        </div>
        ...
        <div className="flex justify-end pt-4">
          ...
          >
            ...
            {isSubmitting
              ? "Submitting..."
              : isCompleting
                ? "Complete HT Test Report"
                : "Submit HT Test Report"}
          </button>
        </div>
      </form>
    </div>
