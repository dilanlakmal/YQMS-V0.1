...
const GarmentWashForm = ({
  ...
  useEffect(() => {
    ...
    if (formData.checkedBy) {
      const matchByValue = checkedByOptions.some((o) => o.value === formData.checkedBy);
    ...
    if (formData.approvedBy) {
      const matchByValue = approvedByOptions.some((o) => o.value === formData.approvedBy);
      if (matchByValue) return;
      const byName = users.find((u) => u.name === formData.approvedBy || formData.approvedBy === `(${u.emp_id}) ${u.name}`);
