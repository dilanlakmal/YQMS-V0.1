...
const EMBTestingForm = ({
  ...
  const colorOptions = Array.isArray(availableColors)
    ? availableColors
        .map((c) =>
          (typeof c === "string" ? c : (c?.label ?? c?.value ?? "")).trim(),
        )
        .filter(Boolean)
    : [];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
              ...
              <div className="relative group ant-datepicker-container">
                <AntDatePicker
                  value={
                    (formData.receivedDate ?? formData.recDate)
                      ? dayjs(formData.receivedDate ?? formData.recDate)
                      : null
                  }
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("embPlacement", e.target.value)
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorChange1 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.colorChange1
                      }
                      onChange={(e) =>
                        handleInputChange("colorChange1", e.target.value)
                      }
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorChange5 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.colorChange5
                      }
                      onChange={(e) =>
                        handleInputChange("colorChange5", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5."
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorChange10 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.colorChange10
                      }
                      onChange={(e) =>
                        handleInputChange("colorChange10", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5."
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorChange15 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.colorChange15
                      }
                      onChange={(e) =>
                        handleInputChange("colorChange15", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5."
                    />
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorStaining1 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.colorStaining1
                      }
                      onChange={(e) =>
                        handleInputChange("colorStaining1", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="5"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorStaining5 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.colorStaining5
                      }
                      onChange={(e) =>
                        handleInputChange("colorStaining5", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5."
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorStaining10 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.colorStaining10
                      }
                      onChange={(e) =>
                        handleInputChange("colorStaining10", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5."
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.colorStaining15 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.colorStaining15
                      }
                      onChange={(e) =>
                        handleInputChange("colorStaining15", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="4-5."
                    />
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.appearance1 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.appearance1
                      }
                      onChange={(e) =>
                        handleInputChange("appearance1", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.appearance5 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.appearance5
                      }
                      onChange={(e) =>
                        handleInputChange("appearance5", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="Accepted"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.appearance10 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.appearance10
                      }
                      onChange={(e) =>
                        handleInputChange("appearance10", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="Accepted"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.appearance15 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.appearance15
                      }
                      onChange={(e) =>
                        handleInputChange("appearance15", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="Accepted"
                    />
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      ...
                      value={
                        formData.cracking1 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.cracking1
                      }
                      onChange={(e) =>
                        handleInputChange("cracking1", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="N/A"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      ...
                      value={
                        formData.cracking5 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.cracking5
                      }
                      onChange={(e) =>
                        handleInputChange("cracking5", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="N/A"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      ...
                      value={
                        formData.cracking10 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.cracking10
                      }
                      onChange={(e) =>
                        handleInputChange("cracking10", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="N/A"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      ...
                      value={
                        formData.cracking15 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.cracking15
                      }
                      onChange={(e) =>
                        handleInputChange("cracking15", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="N/A"
                    />
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.fading1 || EMB_PRINT_WASH_TEST_DEFAULTS.fading1
                      }
                      onChange={(e) =>
                        handleInputChange("fading1", e.target.value)
                      }
                      className="w-full px-2 py-1 border-0 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-center"
                      placeholder="Accepted"
                    />
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      type="text"
                      value={
                        formData.fading5 || EMB_PRINT_WASH_TEST_DEFAULTS.fading5
                      }
                      onChange={(e) =>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      ...
                      value={
                        formData.fading10 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.fading10
                      }
                      onChange={(e) =>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-3 py-2">
                    <input
                      ...
                      value={
                        formData.fading15 ||
                        EMB_PRINT_WASH_TEST_DEFAULTS.fading15
                      }
                      onChange={(e) =>
            ...
            <textarea
              ...
              placeholder={
                isCompleting
                  ...
                  : "Add any additional notes or comments about this test report..."
              }
            />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <CheckCircle2
                    className={`w-4 h-4 ${formData.finalResult === "Accepted" ? "text-white" : "text-gray-300"}`}
                  />
                  Accepted
                </button>
                <button
                ...
                >
                  <XCircle
                    className={`w-4 h-4 ${formData.finalResult === "Rejected" ? "text-white" : "text-gray-300"}`}
                  />
                  Rejected
                </button>
              </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative group ant-datepicker-container">
                <AntDatePicker
                  value={
                    formData.checkedDate ? dayjs(formData.checkedDate) : null
                  }
                  onChange={(date, dateString) =>
                    handleInputChange(
                      "checkedDate",
