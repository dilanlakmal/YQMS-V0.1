...
export const useImageHandling = () => {
  ...
  const handleRemoveImage = useCallback(
    (index, images, setImages, rotationState, setRotationState) => {
  ...
  const rotateImage = useCallback(
    (index, direction, rotationState, setRotationState) => {
  ...
  // Rotate form image
  const rotateFormImage = useCallback(
    (index, direction = "cw") => {
  ...
  const rotateReceivedImage = useCallback(
    (index, direction = "cw") => {
      rotateImage(
        index,
        direction,
  ...
  const rotateCompletionImage = useCallback(
    (index, direction = "cw") => {
      rotateImage(
        index,
        direction,
  ...
  const rotateReportImage = useCallback(
    (reportId, imageKey, direction = "cw") => {
