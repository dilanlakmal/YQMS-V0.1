...
export const updateReportAPI = async (reportId, formData) => {
  ...
  if (contentType && contentType.includes("application/json")) {
    ...
    if (!response.ok) {
      throw new Error(
        result.message || result.error || "Failed to update report",
      );
    }
...
export const updateReceivedStatusAPI = async (reportId, formData) => {
  const response = await fetch(
    `${API_BASE_URL}/api/report-washing/${reportId}/received`,
    {
      method: "PATCH",
      body: formData,
    },
...
export const updateCompletionStatusAPI = async (reportId, formData) => {
  const response = await fetch(
    `${API_BASE_URL}/api/report-washing/${reportId}/completion`,
    {
      method: "PATCH",
      body: formData,
    },
...
export const updateReportImagesAPI = async (reportId, imageType, formData) => {
  const response = await fetch(
    `${API_BASE_URL}/api/report-washing/${reportId}/images/${imageType}`,
    {
      method: "PATCH",
      body: formData,
    },
