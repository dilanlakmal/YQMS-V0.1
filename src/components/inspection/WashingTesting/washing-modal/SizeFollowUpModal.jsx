        ...
        <div className="px-5 py-5 space-y-4">
          ...
          <div>
            <p className="text-[11px] font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-2">
              {sizes.length} size{sizes.length !== 1 ? "s" : ""} included in
              this report
            </p>
          ...
          <div className="rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 px-3 py-2.5 text-xs text-amber-800 dark:text-amber-300 leading-relaxed">
            ...
            <span className="font-semibold">{sizes.length} sizes</span>. Please
            ensure lab testing is performed for each size listed above.
          </div>
        </div>
