            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="md:col-span-2">
                ...
                <select
                  ...
                  required
                >
                  <option value="Garment Wash Report">
                    Garment Wash Report
                  </option>
              ...
              <MultiSelectDropdown
                ...
                label="PO (Optional)"
                options={(() => {
                  const reportPOs = Array.isArray(editingReport.po)
                    ? editingReport.po
                    : editingReport.po
                      ? [editingReport.po]
                      : [];
                  return reportPOs.length > 0
                    ? reportPOs
                    : editAvailablePOs || [];
                })()}
              ...
              <MultiSelectDropdown
                ...
                options={(() => {
                  const reportETDs = Array.isArray(editingReport.exFtyDate)
                    ? editingReport.exFtyDate
                    : editingReport.exFtyDate
                      ? [editingReport.exFtyDate]
                      : [];
                  return reportETDs.length > 0
                    ? reportETDs
                    : editAvailableETDs || [];
                })()}
                selected={editFormData.exFtyDate}
                onChange={(v) =>
                  setEditFormData((p) => ({ ...p, exFtyDate: v }))
                }
              ...
              <MultiSelectDropdown
                ...
                options={(() => {
                  const raw =
                    editingReport.reportSampleSizes ?? editingReport.sampleSize;
                  const reportSizes = Array.isArray(raw)
                    ? raw
                    : raw
                      ? [raw]
                      : [];
                  return reportSizes.length > 0
                    ? reportSizes
                    : editAvailableSizes || [];
                })()}
                selected={editFormData.sampleSize}
                onChange={(v) =>
                  setEditFormData((p) => ({ ...p, sampleSize: v }))
                }
              ...
              <div>
                ...
                <Select
                  value={
                    editFormData.factory
                      ? {
                          value: editFormData.factory,
                          label: editFormData.factory,
                        }
                      : null
                  }
                  ...
                  <AntDatePicker
                    value={
                      editFormData.sendToHomeWashingDate
                        ? dayjs(editFormData.sendToHomeWashingDate)
                        : null
                    }
                    onChange={(date, dateString) =>
                      setEditFormData((prev) => ({
                        ...prev,
                        sendToHomeWashingDate: dateString
