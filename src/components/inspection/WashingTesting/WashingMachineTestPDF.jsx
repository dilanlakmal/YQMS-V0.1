        ...
        <View style={styles.section}>
          <View style={styles.row}>
            <View
              style={[
                styles.col,
                { flexDirection: "row", alignItems: "baseline", width: "100%" },
              ]}
            >
              <Text style={[styles.label, { marginRight: 5, marginBottom: 0 }]}>
                Report Type:
              </Text>
              <Text
                style={[
                  styles.value,
                  { marginBottom: 0, fontWeight: "bold", color: "#1976D2" },
                ]}
              >
          ...
          {!!report.status && (
            <View style={styles.row}>
              ...
              >
                <Text
                  style={[styles.label, { marginRight: 5, marginBottom: 0 }]}
                >
                  Status:
                </Text>
                <Text
                ...
                <>
                  <View style={styles.stepHeader}>
                    <Text style={styles.stepTitle}>
                      Step 1: Sent To Wash ({report.images?.length || 0} imgs)
                    </Text>
                  ...
                  {!!report.notes && (
                    <View style={[styles.notesBox, styles.initialNotesBox]}>
                      <Text
                        style={[styles.notesLabel, styles.initialNotesLabel]}
                      >
                        Notes:
                      </Text>
            ...
            <View style={styles.imageColumn}>
              {!!(
                ...
                <>
                  <View style={styles.stepHeader}>
                    <Text style={styles.stepTitle}>
                      Step 2: Received ({report.receivedImages?.length || 0}{" "}
                      imgs)
                    </Text>
                    <Text style={styles.stepDate}>
                      {report.receivedAt
                  ...
                  {report.receivedImages &&
                    report.receivedImages.length > 0 && (
                      <View style={styles.imagesGrid}>
                  ...
                  {!!report.receivedNotes && (
                    <View style={[styles.notesBox, styles.receivedNotesBox]}>
                      <Text
                        style={[styles.notesLabel, styles.receivedNotesLabel]}
                      >
                        Notes:
                      </Text>
            ...
            <View style={styles.imageColumn}>
              {!!(
                (report.completionImages &&
                  report.completionImages.length > 0) ||
                report.completionNotes
              ) && (
                <>
                  <View style={styles.stepHeader}>
                    <Text style={styles.stepTitle}>
                      Step 3: Done ({report.completionImages?.length || 0} imgs)
                    </Text>
                    <Text style={styles.stepDate}>
                      {report.completedAt
                  ...
                  {!!report.completionNotes && (
                    <View style={[styles.notesBox, styles.completionNotesBox]}>
                      <Text
                        style={[styles.notesLabel, styles.completionNotesLabel]}
                      >
                        Notes:
                      </Text>
                      <Text style={styles.notesContent}>
          ...
          <>
            ...
            {!!(
              ...
              <View style={[styles.section, { marginTop: 10 }]} wrap={false}>
                <View style={styles.stepHeader}>
                  <Text style={styles.stepTitle}>
                    Step 1: Sent To Home Washing ({report.images?.length || 0}{" "}
                    images)
                  </Text>
                  <Text style={styles.stepDate}>
                ...
                {!!report.notes && (
                  <View style={[styles.notesBox, styles.initialNotesBox]}>
                    <Text style={[styles.notesLabel, styles.initialNotesLabel]}>
                      Notes:
                    </Text>
                    <Text style={styles.notesContent}>{report.notes}</Text>
                  </View>
            ...
            {!!(
              ...
              <View style={styles.section} wrap={false}>
                <View style={styles.stepHeader}>
                  <Text style={styles.stepTitle}>
                    Step 3: Completed ({report.completionImages?.length || 0}{" "}
                    images)
                  </Text>
                  <Text style={styles.stepDate}>
                    {report.completedAt
