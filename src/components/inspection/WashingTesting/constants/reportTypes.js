...
const HT_TESTING_FIELDS = {
  ...
  fabrication: {
    ...
    required: false,
    placeholder:
      "Enter fabric composition (e.g., 86% NYLON SUPPLEX 14% LYCRA SPANDEX KNITTED, JERSEY)",
    rows: 2,
  },
  time: {
    type: FIELD_TYPES.TEXT,
  ...
  testMethod: {
    ...
    required: false,
    placeholder:
      "Describe test method (e.g., 15 cycle washed at 30°c + tumble dry low heat after each cycle washed.)",
    rows: 2,
  },
  detergents: {
    type: FIELD_TYPES.TEXT,
  ...
  colorChangeFabric3: {
    type: FIELD_TYPES.TEXT,
    label: "Colour change of fabric (3x)",
    required: false,
  },
  colorChangeFabric5: {
    type: FIELD_TYPES.TEXT,
    label: "Colour change of fabric (5x)",
    required: false,
  },
  colorChangeFabric10: {
    type: FIELD_TYPES.TEXT,
    label: "Colour change of fabric (10x)",
    required: false,
  },
  colorChangeFabric15: {
    type: FIELD_TYPES.TEXT,
    label: "Colour change of fabric (15x)",
    required: false,
  },
  colorStainingHT3: {
    type: FIELD_TYPES.TEXT,
    label: "Colour staining of HT (3x)",
    required: false,
  },
  colorStainingHT5: {
    type: FIELD_TYPES.TEXT,
    label: "Colour staining of HT (5x)",
    required: false,
  },
  colorStainingHT10: {
    type: FIELD_TYPES.TEXT,
    label: "Colour staining of HT (10x)",
    required: false,
  },
  colorStainingHT15: {
    type: FIELD_TYPES.TEXT,
    label: "Colour staining of HT (15x)",
    required: false,
  },
  appearanceAfterWashing3: {
    type: FIELD_TYPES.TEXT,
    label: "Appearance after washing (3x)",
    required: false,
  },
  appearanceAfterWashing5: {
    type: FIELD_TYPES.TEXT,
    label: "Appearance after washing (5x)",
    required: false,
  },
  appearanceAfterWashing10: {
    type: FIELD_TYPES.TEXT,
    label: "Appearance after washing (10x)",
    required: false,
  },
  appearanceAfterWashing15: {
    type: FIELD_TYPES.TEXT,
    label: "Appearance after washing (15x)",
    required: false,
  },
...
const EMB_TESTING_FIELDS = {
  ...
  fabrication: {
    ...
    required: false,
    placeholder:
      "Enter fabric composition (e.g., 92% COTTON 8% SPANDEX KNITTED FLEECE)",
    rows: 2,
  },
  time: {
    type: FIELD_TYPES.TEXT,
  ...
  colorChange1: {
    type: FIELD_TYPES.TEXT,
    label: "Color Change (1x)",
    required: false,
  },
  colorChange5: {
    type: FIELD_TYPES.TEXT,
    label: "Color Change (5x)",
    required: false,
  },
  colorChange10: {
    type: FIELD_TYPES.TEXT,
    label: "Color Change (10x)",
    required: false,
  },
  colorChange15: {
    type: FIELD_TYPES.TEXT,
    label: "Color Change (15x)",
    required: false,
  },
  colorStaining1: {
    type: FIELD_TYPES.TEXT,
    label: "Color Staining (1x)",
    required: false,
  },
  colorStaining5: {
    type: FIELD_TYPES.TEXT,
    label: "Color Staining (5x)",
    required: false,
  },
  colorStaining10: {
    type: FIELD_TYPES.TEXT,
    label: "Color Staining (10x)",
    required: false,
  },
  colorStaining15: {
    type: FIELD_TYPES.TEXT,
    label: "Color Staining (15x)",
    required: false,
  },
  appearance1: {
    type: FIELD_TYPES.TEXT,
  ...
  appearance10: {
    type: FIELD_TYPES.TEXT,
    label: "Appearance (10x)",
    required: false,
  },
  appearance15: {
    type: FIELD_TYPES.TEXT,
    label: "Appearance (15x)",
    required: false,
  },
  cracking1: {
    type: FIELD_TYPES.TEXT,
...
const GARMENT_WASH_FIELDS = {
  ...
  washType: {
    ...
    label: "Wash Type",
    required: true,
    options: ["Before Wash", "After Wash"],
  },
  moNo: {
    type: FIELD_TYPES.TEXT,
    label: "MO NO",
  ...
  mainFabric: {
    type: FIELD_TYPES.TEXT,
    label: "MATERIAL MAIN FABRIC",
    required: true,
  },
  liningInserts: {
    type: FIELD_TYPES.TEXT,
    label: "MATERIAL LINING/INSERTS",
    required: true,
  },
  ...
  colorFastnessRows: {
    type: FIELD_TYPES.CUSTOM,
    label: "Color Fastness Data",
    required: false,
  },
  colorStainingRows: {
    type: FIELD_TYPES.CUSTOM,
    label: "Color Staining Data",
    required: false,
  },
  visualAssessmentRows: {
    type: FIELD_TYPES.CUSTOM,
    label: "Visual Assessment Data",
    required: false,
  },
  shrinkageRows: {
    type: FIELD_TYPES.CUSTOM,
    label: "Shrinkage Data",
    required: false,
  },
  ...
  beforeWashComments: {
    type: FIELD_TYPES.TEXTAREA,
    label: "BEFORE WASH COMMENTS",
    required: false,
  },
  afterWashComments: {
    type: FIELD_TYPES.TEXTAREA,
    label: "AFTER WASH COMMENTS",
    required: false,
  },
...
export const getReportTypeConfig = (reportType) => {
  return (
    REPORT_TYPE_CONFIGS[reportType] ||
    REPORT_TYPE_CONFIGS[REPORT_TYPES.HOME_WASH]
  );
};
