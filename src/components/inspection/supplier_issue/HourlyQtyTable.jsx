...
// const HourlyQtyTable = ({ hourlyQtys, setHourlyQtys }) => {
//   const hours = Array.from({ length: 8 }, (_, i) => i + 1);

//   const handleQtyChange = (hour, value) => {
//     const newQtys = { ...hourlyQtys, [hour]: value };
//     setHourlyQtys(newQtys);
//   };
...
//                     className="w-full text-center p-2 bg-gray-50 dark:bg-gray-700/50 border border-gray-300 dark:border-gray-600 rounded-md"
//                     placeholder="Qty"
//                   />
//                 </td>
//               ))}
...
// src/components/Inspection/SupplierInspection/HourlyQtyTable.js
