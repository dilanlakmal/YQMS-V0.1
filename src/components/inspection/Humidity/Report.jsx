    ...
    const fetchOrderNoSuggestions = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:5001/api/yorksys-orders?limit=0`
        );
          ...
          <>
            ...
            <div className="bg-white p-6 mb-1 border-b ">
              ...
              {checkHistory.length > 0 && (
                <div className="mb-6 p-4 border border-blue-200 rounded-lg bg-blue-50">
                  ...
                  <div className="text-sm text-gray-700 mb-3 ml-7">
                    ...
                    <span className="ml-4 font-medium">Total Checks:</span>{" "}
                    {checkHistory.length}
                  </div>
                      ...
                      >
                        ...
                        m.matchedFiberLimitNumber !== undefined ? (
                          ...
                          <div className="text-xs text-gray-500 mt-1">
                            {m.matchedFiberName ? (
                              <div>
                                Could not compute (missing numeric percentage or
                                limit)
                              </div>
                            ) : (
                              <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Buyer Style #<span className="text-red-500 ml-1">*</span>
                  </label>
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${
                        errors.buyerStyle ? "border-red-500" : "border-gray-300"
                      }`}
                      placeholder=""
                      required
                      aria-required="true"
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${
                      errors.aquaboySpec ? "border-red-500" : "border-gray-300"
                    }`}
                    placeholder=""
                    required
                    aria-required="true"
                ...
                {(formData.inspectionType === "Inline" ||
                  ["Pre-Final", "Final"].includes(formData.inspectionType)) && (
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Before Dry Room
                      <span className="text-red-500 ml-1">*</span>
                          ...
                          <div className="flex items-center w-full md:w-auto mb-2 md:mb-0">
                            <div className="sr-only">
                              <label className="flex items-center gap-1">
                                ...
                                />
                                <span className="text-green-700 font-semibold text-base ml-1">
                                  Pass
                                </span>
                              </label>
                              <label className="flex items-center gap-1">
                                ...
                                />
                                <span className="text-red-700 font-semibold text-base ml-1">
                                  Fail
                                </span>
                              </label>
                            </div>
                    ...
                    <div className="w-full mt-6 border-t pt-6">
                      ...
                      >
                        ...
                        <div className="flex flex-col items-center gap-3">
                          <div
                            className={`w-16 h-16 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center transition-transform duration-300 ${
                              formData.factoryStyleNo
