...
const FormPage = () => {
      ...
      if (order) {
        ...
        try {
          ...
          try {
            ...
            addCalcStep(
              `Error computing aquaboySpecBody: ${sumErr && sumErr.message ? sumErr.message : String(sumErr)}`,
            );
          }
        } catch (mapErr) {
  ...
  const handleEditCheck = (index) => {
    ...
    setFormData((prev) => ({
      ...
      aquaboySpecBody:
        check.aquaboySpecBody ||
        check.aquaboySpec ||
        prev.aquaboySpecBody ||
        "",
                  ...
                  <div className="grid grid-cols-3 gap-6 border-t border-blue-200 mt-6 pt-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <div
                          className={`w-full rounded-lg p-1 border ${errors.aquaboySpecBody ? "border-blue-300 bg-red-50" : "border-blue-200 bg-gradient-to-r from-blue-50/60 to-white"} shadow-inner`}
                        >
                          <div className="relative">
                            <input
                              type="text"
                        ...
                        <div>
                          ...
                          <div>
                            <input
                              ...
                              onFocus={() =>
                                setDefaultBeforeDryRoomTimeIfEmpty()
                              }
                              className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${
