  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const currentEditRecords = formData.inspectionRecords.map((rec) => ({
        ...
        itemName: rec.itemName || `Item ${sourceRecords[index]?.itemName || index + 1}`,
                              ...
                              <div className="flex flex-1 items-center gap-2 w-full">
                                <div className="flex-1">
                                  <input
                                    ...
                                    disabled={isProtected && !unlockedFields[`body-${index}-${section}`]}
                                    onDoubleClick={() => isProtected && toggleUnlock(`body-${index}-${section}`)}
                                    title={isProtected ? "Double-click to edit (Record Protected)" : ""}
                                  />
                                </div>
                                ...
                                <div className="flex flex-1 items-center gap-2 w-full">
                                  <div className="flex-1">
                                    <input
                                      ...
                                      className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300 disabled:bg-gray-50 disabled:cursor-not-allowed transition-all"
                                      disabled={isProtected && !unlockedFields[`ribs-${index}-${section}`]}
                                      onDoubleClick={() => isProtected && toggleUnlock(`ribs-${index}-${section}`)}
                                      title={isProtected ? "Double-click to edit (Record Protected)" : ""}
                                    />
                                  </div>
              ...
              formData.inspectionType === "Final") && (
                <div className="border-t pt-4">
                  ...
                  <div className="space-y-4">
                    {formData.inspectionRecords.map((record, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            {["top", "middle", "bottom"].map((section) => {
                              const isProtected = record.additional?.top?.pass && record.additional?.middle?.pass && record.additional?.bottom?.pass;
                              return (
                                <div
                                  key={section}
                                  className="flex flex-col md:flex-row gap-4 w-full items-center p-3 rounded-xl shadow-sm bg-white border border-gray-100"
                                  ...
                                  <div className="flex flex-1 items-center gap-2 w-full">
                                    <div className="flex-1">
                                      <input
                                        ...
                                        className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300 disabled:bg-gray-50 disabled:cursor-not-allowed transition-all"
                                        disabled={isProtected && !unlockedFields[`add-body-${index}-${section}`]}
                                        onDoubleClick={() => isProtected && toggleUnlock(`add-body-${index}-${section}`)}
                                        title={isProtected ? "Double-click to edit (Record Protected)" : ""}
                                      />
                                    </div>
                                    ...
                                    <div className="flex flex-1 items-center gap-2 w-full">
                                      <div className="flex-1">
                                        <input
                                          ...
                                          className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300 disabled:bg-gray-50 disabled:cursor-not-allowed transition-all"
                                          disabled={isProtected && !unlockedFields[`add-ribs-${index}-${section}`]}
                                          onDoubleClick={() => isProtected && toggleUnlock(`add-ribs-${index}-${section}`)}
                                          title={isProtected ? "Double-click to edit (Record Protected)" : ""}
                                        />
                                      </div>
                    ...
                    {formData.inspectionRecords.every((r) => r.originallyPassed) && (
