        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-white text-sm font-bold mt-1">
              Factory Style No: {report.factoryStyleNo || "N/A"} • Buyer Style:{" "}
              {report.buyerStyle || "N/A"} • Po Line: {report.poLine || "N/A"}
            </p>
          </div>
        </div>
        <button
              ...
              >
                ...
                <div className="bg-white rounded-2xl border border-gray-100/50 p-6 space-y-4 shadow-sm">
                  <div className="flex items-center gap-3 text-emerald-600 border-b border-gray-100 pb-4">
                    ...
                    {isLatest && (
                      <span className="ml-auto bg-emerald-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full uppercase">
                        Latest
                      </span>
                    )}
                  </div>
      ...
      <div className="p-6 bg-white border-t border-slate-100 flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs font-black text-slate-800 leading-none mt-1">
