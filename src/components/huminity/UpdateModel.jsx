...
export default function UpdateModel({ open, onCancel, report, onUpdate }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm p-4 transition-opacity">
            ...
            {message.text && (
                <div className={`fixed bottom-4 right-4 z-[100] flex items-center p-4 mb-4 rounded-lg shadow-xl border transition-all duration-500 animate-in fade-in slide-in-from-bottom-4 ${message.type === 'success' ? 'text-emerald-800 bg-emerald-50 border-emerald-100' : 'text-rose-800 bg-rose-50 border-rose-100'
                    }`} role="alert">
                    {message.type === 'success' ? (
                        <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-full bg-emerald-100 mr-3">
                            <svg className="w-5 h-5 text-emerald-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-full bg-rose-100 mr-3">
                            <svg className="w-5 h-5 text-rose-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <button
                        type="button"
                        className={`p-1.5 inline-flex items-center justify-center h-8 w-8 rounded-lg transition-colors ${message.type === 'success'
