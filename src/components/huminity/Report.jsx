...
const FormPage = () => {
    ...
    const handleOrderNoSelect = async (moNo) => {
        ...
        setFormData(prev => ({ ...prev, factoryStyleNo: moNo }));
        setShowOrderNoDropdown(false);
            ...
            if (order) {
                ...
                try {
                    const detectRibsAvailable = (ord) => {
                        ...
                        if (Array.isArray(ord.SKUData) && ord.SKUData.some(s => s.Ribs !== undefined && s.Ribs !== null && String(s.Ribs).trim() !== '')) return true;
                        if (Array.isArray(ord.FabricContent) && ord.FabricContent.some(fc => fc.ribs !== undefined && fc.ribs !== null && String(fc.ribs).trim() !== '')) return true;
                        try {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 p-2 sm:p-4 md:p-6 ">
            <div className="max-w-[1500px] mx-auto bg-white rounded-xl shadow-lg">
                ...
                {activeTab !== 'Dashboard' && activeTab !== 'Qc-daily-report' && (<>
                    ...
                    <div className="bg-white p-6 mb-1 border-b ">
                        ...
                        {fabricFiberMatches.length > 0 && (
                            <div className="mb-4">
                                <h3 className="font-semibold text-gray-700 mb-2">Fabric → Fiber Calculations</h3>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        readOnly={autoFilledFields.customer}
                                        disabled={!formData.factoryStyleNo}
                    ...
                    <div className="bg-white p-8 border-b flex flex-col">
                        <h2 className="text-xl font-semibold text-gray-800 mb-6">Inspection Records</h2>
                        <div className="flex flex-wrap justify-center gap-8 w-full">
                            {formData.inspectionRecords.map((record, index) => (
                                <div
                                    key={index}
                                    className="w-full border border-gray-200 rounded-2xl shadow-sm p-6 bg-white mb-6 flex flex-col items-center max-w-6xl">
                                                ...
                                                <div className="flex items-center w-full md:w-auto mb-2 md:mb-0">
                                                    <div className="sr-only">
                                                        <label className="flex items-center gap-1">
                                                            ...
                                                            />
                                                            <span className="text-green-700 font-semibold text-base ml-1">Pass</span>
                                                        </label>
                                                        <label className="flex items-center gap-1">
                                                            <input
                                                                type="checkbox"
                                                            ...
                                                            />
                                                            <span className="text-red-700 font-semibold text-base ml-1">Fail</span>
                                                        </label>
                                                    </div>
                    ...
                    {/* Action Buttons */}
                    <div className="bg-white p-6 flex flex-col sm:flex-row gap-4 justify-end">
                        <button
                            onClick={handleSubmit}
                            disabled={isSaving}
                            className="px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors font-semibold flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed">
                            {isSaving ? (
                                <>
                ...
                {message.text && (
                    <div className={`fixed bottom-4 right-4 z-50 flex items-center p-4 mb-4 rounded-lg transition-opacity duration-300 ${message.type === 'success' ? 'text-green-800 bg-green-50' : 'text-red-800 bg-red-50'
                        }`} role="alert">
                        {message.type === 'success' ? (
                            <div className="inline-flex items-center justify-center flex-shrink-0 w-5 h-5">
                                <svg className="w-5 h-5 text-green-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="inline-flex items-center justify-center flex-shrink-0 w-5 h-5">
                                <svg className="w-5 h-5 text-red-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <button
                            type="button"
                            className={`ml-3 -mx-1.5 -my-1.5 rounded-lg focus:ring-2 p-1.5 inline-flex items-center justify-center h-8 w-8 ${message.type === 'success'
