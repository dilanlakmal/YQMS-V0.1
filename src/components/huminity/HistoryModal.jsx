                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 text-green-500 text-sm font-medium">
                                <span className="bg-green-500/20 px-2 py-0.5 rounded text-green-500 backdrop-blur-sm">{report.factoryStyleNo || 'N/A'}</span>
                                <span className="opacity-70">•</span>
                                <span className="text-green-500/90">{report.buyerStyle || 'N/A'}</span>
                            </div>
                            <div className="flex flex-wrap items-center gap-2 text-green-600/80 text-[11px] font-bold mt-2">
                                <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/40 border border-green-200/50 rounded-lg shadow-sm backdrop-blur-sm">
                                    <span className="text-[12px] uppercase text-green-600/60 tracking-wider">Customer:</span>
                                    <span className="text-green-700 text-[12px]">{report.customer || 'N/A'}</span>
                                </div>
                                <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/40 border border-green-200/50 rounded-lg shadow-sm backdrop-blur-sm">
                                    <span className="text-[12px] uppercase text-green-600/60 tracking-wider">Fabrication:</span>
                                    <span className="text-green-700 text-[12px]">{report.fabrication || 'N/A'}</span>
                                </div>
                                <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/40 border border-green-200/50 rounded-lg shadow-sm backdrop-blur-sm">
                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-100 border-b">
                            {history.map((check, checkIdx) => (
                                <tr key={checkIdx} className="hover:bg-indigo-50/50 transition-colors group border-b">
                                    <td className="px-4 py-3.5 text-center font-bold text-gray-400 group-hover:text-indigo-600 transition-colors">{checkIdx + 1}</td>
