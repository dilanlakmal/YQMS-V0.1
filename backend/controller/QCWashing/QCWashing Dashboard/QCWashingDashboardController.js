    ...
    const measurementSummary = await QCWashing.aggregate([
      ...
      { $unwind: "$measurementDetails.measurementSizeSummary" },
      {
        $group: {
          ...
          totalPoints: {
            $sum: "$measurementDetails.measurementSizeSummary.checkedPoints",
          },
          passPoints: {
            $sum: "$measurementDetails.measurementSizeSummary.totalPass",
          },
          failPoints: {
            $sum: "$measurementDetails.measurementSizeSummary.totalFail",
          },
          pcsChecked: {
            $sum: "$measurementDetails.measurementSizeSummary.checkedPcs",
          },
        },
      },
      { $sort: { _id: 1 } },
        ...
        $project: {
          ...
          accuracy: {
            $cond: [
              ...
              0,
              {
                $multiply: [{ $divide: ["$passPoints", "$totalPoints"] }, 100],
              },
            ],
          },
        ...
        $project: {
          ...
          defectRate: {
            $cond: [
              ...
              {
                $multiply: [
                  { $divide: ["$totalDefects", "$totalPiecesChecked"] },
                  100,
                ],
              },
            ],
      ...
      { $unwind: "$measurementDetails.measurementSizeSummary" },
      {
        $group: {
          ...
          totalPlusFail: {
            $sum: {
              $ifNull: [
                "$measurementDetails.measurementSizeSummary.plusToleranceFailCount",
                0,
              ],
            },
          },
          totalMinusFail: {
            $sum: {
              $ifNull: [
                "$measurementDetails.measurementSizeSummary.minusToleranceFailCount",
                0,
              ],
            },
          },
        ...
        $project: {
          ...
          accuracy: {
            $cond: [
              ...
              {
                $multiply: [
                  { $divide: ["$totalPass", "$totalCheckedPoints"] },
                  100,
                ],
              },
            ],
