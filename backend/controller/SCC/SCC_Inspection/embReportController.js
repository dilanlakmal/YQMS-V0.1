import { EMBReport } from "../../MongoDB/dbConnectionController.js";
...
export const saveEMBReport = async (req, res) => {
  try {
    ...
    if (
      defectImageUrl &&
      typeof defectImageUrl === "string" &&
      defectImageUrl.startsWith("undefined/")
    ) {
      defectImageUrl = defectImageUrl.replace("undefined", "");
    }
    ...
    const reportData = {
      reportType,
      inspectionDate: normalizeToMidnightUTC(inspectionDate),
      factoryName,
      moNo,
      buyer,
      buyerStyle,
