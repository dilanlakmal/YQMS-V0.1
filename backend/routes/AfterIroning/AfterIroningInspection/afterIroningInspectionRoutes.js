import {
  ...
  checkAfterIroningSubmittedStyle,
...
router.post(
  "/api/after-ironing/first-output-details",
  saveqcwashingFirstOutput
);
router.post(
  "/api/after-ironing/check-submitted-style",
  checkAfterIroningSubmittedStyle
);
router.post("/api/after-ironing/check-qc-washing-record", checkQCWashingRecord);
router.get(
  "/api/after-ironing/check-measurement-details/:orderNo",
  getAfterIroningMeasurementData
);
...
router.post(
  "/api/after-ironing/check-submitted",
  checkAfterIroningSubmittedRecord
);
...
router.get(
  "/api/after-ironing/saved-sizes/:orderNo/:color(*)",
  cleanupColor,
  getqcwashingSavedColor
);
...
router.post(
  "/api/after-ironing/inspection-save",
  uploadInspectionImage.any(),
  saveAfterIroningInspectionData
);
router.post(
  "/api/after-ironing/inspection-update",
  uploadInspectionImage.any(),
  updateAfterIroningInspectionData
);
...
router.post(
  "/api/after-ironing/defect-details-save",
  uploadDefectImage.any(),
  saveAfterIroningDefectData
);
router.post(
  "/api/after-ironing/defect-details-update",
  uploadDefectImage.any(),
  updateAfterIroningDefectData
);
...
router.post(
  "/api/after-ironing/find-saved-measurement",
  savedMeasurementDataSpec
);
router.get(
  "/api/after-ironing/order-sizes/:orderNo",
  getAfterIroningOrderSizes
);
...
router.post(
  "/api/after-ironing/save-summary/:recordId",
  saveAfterIroningSummary
);
...
------------------------------ */
router.post(
  "/api/after-ironing/measurement-summary-autosave/:recordId",
  updateAfterIroningMeasurementData
);
...
------------------------------ */
router.get(
  "/api/after-ironing/overall-summary-by-id/:recordId",
  getAfterIroningOverAllSummary
);
router.get(
  "/api/after-ironing/order-color-qty/:orderNo/:color(*)",
  cleanupColor,
  getAfterIroningOrderColorQty
);
router.get("/api/after-ironing/order-numbers", getAfterIroningOrderNumbers);
router.get(
  "/api/after-ironing/order-details-by-style/:orderNo",
  getAfterIroningOrderbysize
);
router.get(
  "/api/after-ironing/order-details-by-order/:orderNo",
  getAfterIroningOrderbyOrderNo
);
router.get("/api/after-ironing/load-saved-by-id/:id", getAfterIroningSaveData);
router.post(
  "/api/after-ironing/aql-chart/find-by-sample-size",
  saveAfterIroningAQLbySampleSize
);
router.post("/api/after-ironing/aql-chart/find", saveAfterIroningAQLData);
router.post(
  "/api/after-ironing/measurement-save",
  saveAfterIroningMeasurementData
);
router.post(
  "/api/after-ironing/measurement-size-save",
  saveAfterIroningMeasurementData
);
router.get(
  "/api/after-ironing/load-color-data/:orderNo/:color(*)",
  cleanupColor,
  loadAfterIroningColorData
);
...
router.get(
  "/api/after-ironing-checkpoint-definitions",
  getAfterIroningCheckpointDefinitions
);
...
router.get(
  "/api/after-ironing/qc-washing-measurement",
  getQCWashingMeasurementData
);
