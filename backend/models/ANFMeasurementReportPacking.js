...
// Main Report Schema - PACKING (M2)
const ANFMeasurementReportPackingSchema = new mongoose.Schema(
  {
...
ANFMeasurementReportPackingSchema.index(
...
export default (connection) =>
  connection.model(
    ...
    ANFMeasurementReportPackingSchema
  );
