...
import { compressImage, saveCompressedImage, generateUniqueFilename, deleteImage } from "./Utils/imageCompression.js";
...
import {    
  sanitize, 
  getOperatorModel, getBuyerFromMoNumber} from "./Helpers/helperFunctions.js";
import qcRealWashQty from "./routes/QC_Real_Wash_Qty/QcRealWashQtyRoute.js";
import aql from "../backend/routes/AQL/AQLRoutes.js";
...
app.post("/api/qc-washing/recalculate-overall-result/:recordId", async (req, res) => {
  try {
    const { recordId } = req.params;
