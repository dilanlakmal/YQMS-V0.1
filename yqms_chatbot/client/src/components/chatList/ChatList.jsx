          ...
          <div className="chatList-brand">
              {isDashboardPage ? (
                  <div className="brand-logo" style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    {/* Interactive Bots Icon with Animation */}
                    <span className="animated-bot-icon" style={{ display: "inline-flex", alignItems: "center" }}>
                      ...
                      <span
                        ...
                        style={{
                          ...
                          animation: "waveWiggle 2s infinite"
                        }}
                      >👋</span>
                    </span>
                    <p className="animated-text" style={{ marginLeft: "6px" }}>
                      {Array.from("AI Agent For YQMS").map((char, idx) =>
                        <span
                          key={idx}
                          style={{
                            display: 'inline-block',
                            animation: `textFadeIn 0.7s ease ${idx * 0.05}s forwards`,
                            opacity: 0,
                          }}
                        >
                          {char === " " ? "\u00A0" : char}
                  ...
                  isPending ? (
                      ...
                      <div className="brand-logo">
                          {/* <img src="/logo.png" alt="YAI-Bot" />
                          <div className="brand-text">
                              <span className="brand-name">YAI-Bot</span>
